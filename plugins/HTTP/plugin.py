...
#
"""
<plugin key="Google" name="Goolgle Home page example" author="Dnpwwo" version="1.1.1" externallink="https://www.google.com">
    <params>
...
class BasePlugin:
    ...
    def onConnect(self, Connection, Status, Description):
        if (Status == 0):
            Domoticz.Log("Google connected successfully.")
            sendData = { 'Verb' : 'GET',
                         'URL'  : '/',
