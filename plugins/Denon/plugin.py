...
#
"""
<plugin key="Denon4306" version="3.0.3" name="Denon/Marantz Amplifier" author="dnpwwo" wikilink="" externallink="http://www.denon.co.uk/uk">
    <description>
        ...
        try:
            ...
            if (Connection.Name == "Beacon"):
                ...
                if (strData.find(Parameters["Mode2"]) >= 0):
                    ...
                    Domoticz.Log("Amplifier '"+Parameters["Address"]+"' discovered successfully at address: "+Connection.Address)
                else:
                    Domoticz.Log("Saw discovery message for: "+devDetail)
