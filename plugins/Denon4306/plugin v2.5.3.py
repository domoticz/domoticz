...
#
"""
<plugin key="Denon4306" version="2.5.3" name="Denon AVR 4306 Amplifier" author="dnpwwo" wikilink="" externallink="http://www.denon.co.uk/uk">
    <params>
...
class BasePlugin:
    ...
    def onStart(self):
        ...
        if (len(Devices) == 0):
            ...
            Domoticz.Device(Name="Main Zone", Unit=2, TypeName="Selector Switch", Switchtype=18, Image=5, \
