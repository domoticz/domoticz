...
#### RGBW / Lighting Limitless/Applamp
 ...
 - **setKelvin(Kelvin)**: *Function*. <sup>2.4.0</sup> Sets Kelvin level of the light. Supports [command options](#Command_options_.28delay.2C_duration.2C_event_triggering.29).
