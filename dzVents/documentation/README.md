...
### Device attributes and methods for all devices
 ...
 - **setDescription(description)**: *Function*. <sup>2.4.16</sup> Generic update method for all devices, groups and scenes. E.g.: device.setDescription(device.description .. '/nChanged by '.. item.trigger .. 'at ' .. domoticz.time.raw). Supports [command options](#Command_options_.28delay.2C_duration.2C_event_triggering.29).  
...
#### Logitech Media Server
 ...
 - **switchOff()**: *Function*. <sup>2.4.16</sup> Will turn the device off. Supports [command options](#Command_options_.28delay.2C_duration.2C_event_triggering.29).
 - **volumeUp()**: *Function*. <sup>2.4.0</sup> Will turn the device volume up with 2 points. Supports [command options](#Command_options_.28delay.2C_duration.2C_event_triggering.29).
...
# Change log
##[2.4.16]
- Add method dump() to domoticz.settings
