...
*LOG_DEBUG will cause Execution Info to be displayed (start/finished), but actual messages will only be displayed when Domoticz is started with debug logging enabled
