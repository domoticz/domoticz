...
return {
	...
	process = function (device, data, domoticz, utils, adapterManager)
		...
		function device.setColor(r,g,b,br,cw,ww,m,t)
			...
			local colors     = domoticz.utils.fromJSON(device.color or '{"t":0,"cw":0,"ww":0}')
			local brightness = br or 100
			if br == nil then
				_ , _ , brightness = domoticz.utils.rgbToHSB(r, g, b)
			end
		...
		function device.setColorBrightness()
		   return device.setColor(r,g,b,br,cw,ww,m,t)
		end

		function device.setHex(r,g,b)
				_ , _ , brightness = domoticz.utils.rgbToHSB(r, g, b)
				hex = string.format("%02x",r) .. string.format("%02x",g) .. string.format("%02x",b)
