...
describe('variables', function()
	...
	it('should set a new float value', function()
		...
		assert.is_same({ ['Variable'] = { name = 'y', value='12.5', _trigger=true } }, commandArray[1])
	end)
	...
	it('should set a new integer value', function()
		...
		var.set(12)
		assert.is_same(1, _.size(commandArray))
		assert.is_same({ ['Variable'] = { name = 'x', value='12', _trigger=true } }, commandArray[1])
	end)
	...
	it('should set a new string value', function()
		...
		var.set('dzVents')
		assert.is_same(1, _.size(commandArray))
		assert.is_same({ ['Variable'] = { name = 'z', value='dzVents', _trigger=true } }, commandArray[1])
	end)
	...
	it('should set a new date value', function()
		...
		var.set('12/12/2012')
		assert.is_same(1, _.size(commandArray))
		assert.is_same({ ['Variable'] = { name = 'a', value='12/12/2012', _trigger=true } }, commandArray[1])
	end)
	...
	it('should set a new time value', function()
		...
		var.set('12:34')
		assert.is_same(1, _.size(commandArray))
		assert.is_same({ ['Variable'] = { name = 'b', value='12:34', _trigger=true } }, commandArray[1])
	end)
	...
	it('should set a make a timed command', function()
		...
		assert.is_same(1, _.size(commandArray))
		assert.is_same({ ['Variable'] = { name = 'z', value='dzVents', _trigger = true, _after = 5 } }, commandArray[1])
	end)
