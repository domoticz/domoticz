...
@Component({
  selector: 'dz-air-quality-month-graph',
  templateUrl: './air-quality-month-graph.component.html',
  styleUrls: ['./air-quality-month-graph.component.css']
})
export class AirQualityMonthGraphComponent implements OnInit, AfterViewInit {
  ...
  private loadGraph() {
    ...
    const options: Options = {
      ...
      title: {
        text: this.translationService.t('Air Quality') + ' ' + this.translationService.t('Last Month')
      },
      xAxis: {
        type: 'datetime'
      },
