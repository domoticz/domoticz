...
@Component({
  selector: 'dz-rain-month-graph',
  templateUrl: './rain-month-graph.component.html',
  styleUrls: ['./rain-month-graph.component.css']
})
export class RainMonthGraphComponent implements OnInit, AfterViewInit {
  ...
  private loadGraph() {
    ...
    const options: Highcharts.Options = {
      chart: {
        ...
        events: {
          load: () => {
            _this.graphService.getData('month', _this.idx, 'rain').subscribe(data => {
      ...
      title: {
        text: this.translationService.t('Rainfall') + ' ' + this.translationService.t('Last Month')
      },
      xAxis: {
        type: 'datetime'
      },
