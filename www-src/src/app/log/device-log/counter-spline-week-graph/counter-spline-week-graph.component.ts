...
@Component({
  selector: 'dz-counter-spline-week-graph',
  templateUrl: './counter-spline-week-graph.component.html',
  styleUrls: ['./counter-spline-week-graph.component.css']
})
export class CounterSplineWeekGraphComponent implements OnInit, AfterViewInit {
