...
import { CounterSplineLogComponent } from './counter-spline-log.component';
...
describe('CounterSplineLogComponent', () => {
  let component: CounterSplineLogComponent;
  let fixture: ComponentFixture<CounterSplineLogComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CounterSplineLogComponent);
