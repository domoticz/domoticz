...
@Component({
  selector: 'dz-counter-year-graph',
  templateUrl: './counter-year-graph.component.html',
  styleUrls: ['./counter-year-graph.component.css']
})
export class CounterYearGraphComponent implements OnInit, AfterViewInit {
