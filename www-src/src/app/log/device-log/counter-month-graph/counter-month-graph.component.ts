...
@Component({
  selector: 'dz-counter-month-graph',
  templateUrl: './counter-month-graph.component.html',
  styleUrls: ['./counter-month-graph.component.css']
})
export class CounterMonthGraphComponent implements OnInit, AfterViewInit {
