...
@Component({
  selector: 'dz-counter-spline-year-graph',
  templateUrl: './counter-spline-year-graph.component.html',
  styleUrls: ['./counter-spline-year-graph.component.css']
})
export class CounterSplineYearGraphComponent implements OnInit, AfterViewInit {
