...
import { SmartLogComponent } from './smart-log.component';
...
describe('SmartLogComponent', () => {
  let component: SmartLogComponent;
  let fixture: ComponentFixture<SmartLogComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SmartLogComponent);
