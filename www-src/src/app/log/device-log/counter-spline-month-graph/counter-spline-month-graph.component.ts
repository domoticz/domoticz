...
@Component({
  selector: 'dz-counter-spline-month-graph',
  templateUrl: './counter-spline-month-graph.component.html',
  styleUrls: ['./counter-spline-month-graph.component.css']
})
export class CounterSplineMonthGraphComponent implements OnInit, AfterViewInit {
