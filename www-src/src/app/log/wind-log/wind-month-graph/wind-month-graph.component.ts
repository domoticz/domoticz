...
@Component({
  selector: 'dz-wind-month-graph',
  templateUrl: './wind-month-graph.component.html',
  styleUrls: ['./wind-month-graph.component.css']
})
export class WindMonthGraphComponent implements OnInit, AfterViewInit {
  ...
  private loadGraph() {
    ...
    const options: Highcharts.Options = {
      chart: {
        ...
        events: {
          load: () => {
            _this.graphService.getData('month', _this.idx, 'wind').subscribe(data => {
      ...
      title: {
        text: this.translationService.t('Wind') + ' ' + this.translationService.t('speed/gust') + ' ' + this.translationService.t('Last Month')
      },
      xAxis: {
        type: 'datetime'
      },
