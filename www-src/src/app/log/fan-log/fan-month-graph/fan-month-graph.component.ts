...
@Component({
  selector: 'dz-fan-month-graph',
  templateUrl: './fan-month-graph.component.html',
  styleUrls: ['./fan-month-graph.component.css']
})
export class FanMonthGraphComponent implements OnInit, AfterViewInit {
  ...
  private loadGraph() {
    ...
    const options: Highcharts.Options = {
      chart: {
        ...
        events: {
          load: function () {
            _this.graphService.getData('month', _this.idx, 'fan').subscribe(data => {
      ...
      title: {
        text: this.translationService.t('RPM') + ' ' + this.translationService.t('Last Month')
      },
      xAxis: {
        type: 'datetime'
      },
