...
@Component({
  selector: 'dz-current-day-graph',
  templateUrl: './current-day-graph.component.html',
  styleUrls: ['./current-day-graph.component.css']
})
export class CurrentDayGraphComponent implements OnInit, AfterViewInit {
          ...
          load: function () {
            _this.graphService.getData('day', _this.idx, 'counter').subscribe(data => {
              if (typeof data.result !== 'undefined') {
                _this.graphService.AddDataToCurrentChart(data, _this.chart, _this.switchtype, 1);
                _this.chart.redraw();
              }
            });
          }
