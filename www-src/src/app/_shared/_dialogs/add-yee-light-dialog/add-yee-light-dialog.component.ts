...
@Component({
  selector: 'dz-add-yee-light-dialog',
  templateUrl: './add-yee-light-dialog.component.html',
  styleUrls: ['./add-yee-light-dialog.component.css']
})
export class AddYeeLightDialogComponent extends DialogComponent implements OnInit {
  ...
  protected getDialogId(): string {
    return 'dialog-addyeelight';
  }

  protected getDialogTitle(): string {
    return 'Add YeeLight Light';
  }
  ...
  protected getDialogButtons() {
    return {
      'OK': () => {
        ...
        this.hardwareService.addYeeLight(this.idx, SensorName, IPAddress, SensorType).subscribe((data) => {
          if (data.status === 'OK') {
