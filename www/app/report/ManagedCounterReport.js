define(['app', 'report/helpers'], function (app, reportHelpers) {
    app.factory('DeviceManagedCounterReportData', function ($q, domoticzApi) {
        return {
            fetch: fetch
        };
    ...
    app.component('deviceManagedCounterReport', {
        bindings: {
            device: '<',
            selectedYear: '<',
            selectedMonth: '<'
        },
        templateUrl: 'app/report/ManagedCounterReport.html',
        controller: DeviceManagedCounterReportController
    });


    function DeviceManagedCounterReportController($element, DeviceManagedCounterReportData, dataTableDefaultSettings) {
        var vm = this;
        vm.$onInit = init;
        ...
        function getData() {
            DeviceManagedCounterReportData
