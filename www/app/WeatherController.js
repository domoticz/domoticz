                            ...
                            ctrl.items.forEach(function(olditem, oldindex, oldarray) {
                                if (olditem.idx == newitem.idx) {
                                    ...
                                    if ($scope.config.ShowUpdatedEffect == true) {
                                        $("#weatherwidgets #" + newitem.idx + " #name").effect("highlight", {
                                            color: "#EEFFEE"
                                        }, 1e3);
                                    }
                                }
        ...
        function init() {
            ...
            dialog_editweatherdevice_buttons[$.t("Update")] = function() {
                ...
                if (bValid) {
                    $(this).dialog("close");
                    $.ajax({
                        url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editweatherdevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editweatherdevice #devicedescription").val()) + "&used=true",
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            ShowWeathers();
            ...
            dialog_editweatherdevice_buttons[$.t("Remove Device")] = function() {
                ...
                bootbox.confirm($.t("Are you sure to remove this Device?"), function(result) {
                    if (result == true) {
                        $.ajax({
                            url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editweatherdevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editweatherdevice #devicedescription").val()) + "&used=false",
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                ShowWeathers();
            ...
            dialog_editraindevice_buttons[$.t("Update")] = function() {
                ...
                if (bValid) {
                    $(this).dialog("close");
                    $.ajax({
                        url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editraindevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editraindevice #devicedescription").val()) + "&addjmulti=" + $("#dialog-editraindevice #edittable #multiply").val() + "&used=true",
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            ShowWeathers();
            ...
            dialog_editbarodevice_buttons[$.t("Update")] = function() {
                ...
                if (bValid) {
                    ...
                    $.ajax({
                        url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editbarodevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editbarodevice #devicedescription").val()) + "&addjvalue2=" + aValue + "&used=true",
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            ShowWeathers();
            ...
            dialog_editbarodevice_buttons[$.t("Remove Device")] = function() {
                ...
                bootbox.confirm($.t("Are you sure to remove this Device?"), function(result) {
                    if (result == true) {
                        $.ajax({
                            url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editbarodevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editbarodevice #devicedescription").val()) + "&used=false",
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                ShowWeathers();
            ...
            dialog_editvisibilitydevice_buttons[$.t("Update")] = function() {
                ...
                if (bValid) {
                    $(this).dialog("close");
                    $.ajax({
                        url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editvisibilitydevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editvisibilitydevice #devicedescription").val()) + "&switchtype=" + $("#dialog-editvisibilitydevice #combometertype").val() + "&used=true",
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            ShowWeathers();
            ...
            dialog_editvisibilitydevice_buttons[$.t("Remove Device")] = function() {
                ...
                bootbox.confirm($.t("Are you sure to remove this Device?"), function(result) {
                    if (result == true) {
                        $.ajax({
                            url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editvisibilitydevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editvisibilitydevice #devicedescription").val()) + "&used=false",
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                ShowWeathers();
