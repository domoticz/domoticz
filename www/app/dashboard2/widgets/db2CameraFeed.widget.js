define([
    ...
    app.directive('db2CameraFeedWidget', ['$interval', '$sce', function($interval, $sce) {
        return {
            restrict:         'E',
            templateUrl:      'views/dashboard2/widgets/camera-feed.html',
            scope: {
                widgetDef: '=',
                editMode:  '<'
            },
            ...
            controller: ['$scope', '$http', '$interval', '$sce',
                ...
                $scope.$on('db2:widget:refresh', function() {
                    refresh();
                    loadCameraName();
                });
