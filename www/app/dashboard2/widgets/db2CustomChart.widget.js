define([
    ...
    app.directive('db2CustomChartWidget', ['$http', '$timeout', '$q', function($http, $timeout, $q) {
        return {
            restrict:         'E',
            templateUrl:      'views/dashboard2/widgets/custom-chart.html',
            scope: {
                widgetDef: '=',
                editMode:  '<'
            },
            ...
            controller: ['$scope', '$http', '$timeout', '$q', function($scope, $http, $timeout, $q) {
                var ctrl = this;
                ctrl.chartId = 'db2-custom-chart-' + (++chartIdCounter);
                ctrl.isEmpty = false;
                ctrl.error   = null;
