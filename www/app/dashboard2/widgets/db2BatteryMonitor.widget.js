define([
    ...
    app.directive('db2BatteryMonitorWidget', [function() {
        return {
            restrict:         'E',
            templateUrl:      'views/dashboard2/widgets/battery-monitor.html',
            scope: {
                widgetDef: '=',
                editMode:  '<'
            },
            ...
            controller: ['$scope', '$http', '$interval', '$q', function($scope, $http, $interval, $q) {
                ...
                ctrl.levelColor = function(level) {
                    ...
                    if (level <= 25) { return 'var(--dz-widget-energy-import)'; }
                    if (level <= 50) { return 'var(--dz-widget-energy-solar)'; }
