define([
    ...
    app.directive('db2EnergyDashboardWidget', [function() {
        return {
            restrict:         'E',
            templateUrl:      'views/dashboard2/widgets/energy-dashboard.html',
            scope: {
                widgetDef: '=',
                editMode:  '<'
            },
            ...
            controller: ['$scope', '$http', '$interval', '$q', function($scope, $http, $interval, $q) {
                ...
                ctrl.batNetClass = function() {
                    ...
                    return ctrl.balance.batNet >= 0 ? 'db2-energy-import' : 'db2-energy-export';
                };
                ...
                ctrl.battNetClass = function() {
                    ...
                    return ctrl.battery.importedKwh >= ctrl.battery.exportedKwh ? 'db2-energy-import' : 'db2-energy-export';
                };
