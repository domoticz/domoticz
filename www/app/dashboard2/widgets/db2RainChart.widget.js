define([
    ...
    app.directive('db2RainChartWidget', ['$http', '$timeout', '$q', function($http, $timeout, $q) {
        return {
            restrict:         'E',
            templateUrl:      'views/dashboard2/widgets/rain-chart.html',
            scope: {
                widgetDef: '=',
                editMode:  '<'
            },
            ...
            controller: ['$scope', '$http', '$timeout', '$q', function($scope, $http, $timeout, $q) {
                var ctrl = this;
                ctrl.chartId    = 'db2-rain-chart-' + (++chartIdCounter);
                ctrl.deviceName = '';
                var chart        = null;
