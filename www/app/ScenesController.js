					...
					if (typeof data.result != 'undefined') {
						...
						$.each(data.result, function (i, item) {
							...
							if (i != totalItems - 1) {
								...
								updownImg += '<i class="fa-solid fa-arrow-down dz-chrome-icon lcursor" onclick="ChangeDeviceOrder(1,' + item.ID + ');"></i>';
							}
							else {
							...
							if (i != 0) {
								...
								updownImg += '<i class="fa-solid fa-arrow-up dz-chrome-icon lcursor" onclick="ChangeDeviceOrder(0,' + item.ID + ');"></i>';
							}
