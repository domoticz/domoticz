				...
				if (typeof data.result != 'undefined') {
					...
					$.each(data.result, function(i,item){
						...
						if (typeof obj != 'undefined') {
							...
							if (item.Type=="Scene") {
								img1='<img src="images/push48.png" title="' + $.t('Activate') +'" onclick="SwitchScene(' + item.idx + ',\'On\',RefreshScenes,' + item.Protected +');" class="lcursor" height="48" width="48">';
							}
							else {
								var onclass="";
								var offclass="";
			  ...
			  if (typeof data.result != 'undefined') {
				...
				$.each(data.result, function(i,item){
				  ...
				  var xhtm=
					...
					if (item.Type=="Scene") {
						xhtm+='<td id="img1"><img src="images/push48.png" title="' + $.t('Activate') +'" onclick="SwitchScene(' + item.idx + ',\'On\',RefreshScenes, ' + item.Protected +');" class="lcursor" height="48" width="48"></td>\n';
