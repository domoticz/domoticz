									...
									if (($scope.config.DashboardType==2)||(window.myglobals.ismobile==true)) {
										...
										if (item.SwitchType == "Doorbell") {
											...
											if (item.Status == 'Closed') {
												status='<button class="btn btn-mini" type="button" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');">' + $.t("Closed") +'</button>';
											}
											else {
												status='<button class="btn btn-mini btn-info" type="button" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');">' + $.t("Open") +'</button>';
											}
										}
											...
											if (item.Status == 'On')
											{
												status='<button class="btn btn-mini" type="button" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');">' + $.t("Dark") +'</button>';
											}
											else {
												status='<button class="btn btn-mini" type="button" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');">' + $.t("Sunny") +'</button>';
											}
										}
											...
											if (
													...
													(item.Status.indexOf('Set ') == 0)
														...
														status='<button class="btn btn-mini btn-info" type="button" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');">' + $.t("Motion") +'</button>';
											}
											else {
														status='<button class="btn btn-mini" type="button" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');">' + $.t("No Motion") +'</button>';
											}
										}
										else if (item.SwitchType == "Dusk Sensor") {
											if (item.Status == 'On') {
											...
											if ((item.Status == "Panic")||(item.Status == "On")) {
												status='<button class="btn btn-mini btn-info" type="button" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');">' + $.t("SMOKE") +'</button>';
											}
											else {
												status='<button class="btn btn-mini" type="button" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');">' + $.t("No Smoke") +'</button>';
											}
										}
										else {
											if (
										...
										if (item.SwitchType == "Doorbell") {
											...
											if (item.Status == 'Closed') {
												img='<img src="images/contact48.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40" >';
											}
											else {
												img='<img src="images/contact48_open.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40">';
											}
										}
										else if ((item.SwitchType == "Blinds")||(item.SwitchType.indexOf("Venetian Blinds") == 0)) {
											if ((item.SubType=="RAEX")||(item.SubType.indexOf('A-OK') == 0)||(item.SubType.indexOf('RollerTrol') == 0)||(item.SubType=="Harrison")||(item.SubType.indexOf('RFY') == 0)||(item.SubType.indexOf('T6 DC') == 0)||(item.SwitchType.indexOf("Venetian Blinds") == 0)) {
											...
											if (
													(item.Status == 'On')
														...
														img='<img src="images/uvdark.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40">';
											}
											else {
														img='<img src="images/uvsunny.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40">';
											}
										}
										    ...
										    if ((item.Status != 'Off') && (item.Status != '0')) {
										        ...
										        img2 = '<img src="images/remote48.png" onclick="ShowMediaRemote(\'' + btoa(item.Name) + "'," +  item.idx + ');" class="lcursor" height="40" width="40">';
										    }
										    else {
											...
											if (
													...
													(item.Status.indexOf('Set ') == 0)
														...
														img='<img src="images/motion48-on.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40">';
											}
											else {
														img='<img src="images/motion48-off.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40">';
											}
										}
										else if (item.SwitchType == "Smoke Detector") {
												if (
														...
														img='<img src="images/smoke48on.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40">';
												}
												else {
														img='<img src="images/smoke48off.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40">';
												}
										}
										else {
											if (
				...
				$.each(data.result, function(i,item){
					  ...
					  )
				  {
								...
								if (typeof obj != 'undefined') {
									var vname=item.Name;
									if (($scope.config.DashboardType==2)||(window.myglobals.ismobile==true)) {
										var vname='<img src="images/next.png" onclick="ShowTempLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="16" width="16">' + " " + item.Name;
									}
									...
									if (($scope.config.DashboardType==2)||(window.myglobals.ismobile==true)) {
										...
										img+='" class="lcursor" onclick="ShowTempLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40">';
										if ($(id + " #img").html()!=img) {
											$(id + " #img").html(img);
										}
										var status="";
					  ...
					  )
				  {
								...
								if (typeof obj != 'undefined') {
									...
									if (($scope.config.DashboardType==2)||(window.myglobals.ismobile==true)) {
										...
										var bigtext="";
										if (typeof item.Rain != 'undefined') {
											img='<img src="images/rain48.png" class="lcursor" onclick="ShowRainLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40">';
											status=item.Rain + ' mm';
											...
											img='<img src="images/uv48.png" class="lcursor" onclick="ShowUVLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40">';
											status=item.UVI + ' UVI';
											...
											img='<img src="images/Wind' + item.DirectionStr + '.png" class="lcursor" onclick="ShowWindLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40">';
											status=item.Direction + ' ' + item.DirectionStr;
											if (typeof item.Speed != 'undefined') {
												status+=', ' + $.t('Speed') + ': ' + item.Speed + ' ' + $scope.config.WindSign;
											}
											...
											img='<img src="images/baro48.png" class="lcursor" onclick="ShowBaroLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40">';
					...
					var xhtm = "";
								if (($scope.config.DashboardType==2)||(window.myglobals.ismobile==true)) {
									...
									if (item.SwitchType == "Doorbell") {
										...
										if (item.Status == 'Closed') {
											xhtm+='\t      <td id="img"><img src="images/contact48.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40"></td>\n';
										}
										else {
											xhtm+='\t      <td id="img"><img src="images/contact48_open.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40"></td>\n';
										}
									}
									else if (item.SwitchType == "Media Player") {
									    if (item.CustomImage == 0) item.Image = item.TypeImg;
									    if ((item.Status != 'Off') && (item.Status != '0')) {
									        ...
									        xhtm += '\t      <td id="img2"><img src="images/remote48.png" onclick="ShowMediaRemote(\'' + btoa(item.Name) + "'," +  item.idx + ');" class="lcursor" height="40" width="40"></td>\n';
									    }
									    else {
										...
										if (item.Status == 'On')
										{
													xhtm+='\t      <td id="img"><img src="images/uvdark.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40"></td>\n';
										}
										else {
													xhtm+='\t      <td id="img"><img src="images/uvsunny.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40"></td>\n';
										}
									}
									else if (item.SwitchType == "Motion Sensor") {
										if (
												...
												(item.Status.indexOf('Set ') == 0)
													...
													xhtm+='\t      <td id="img"><img src="images/motion48-on.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40"></td>\n';
										}
										else {
													xhtm+='\t      <td id="img"><img src="images/motion48-off.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40"></td>\n';
										}
									}
									else if (item.SwitchType == "Smoke Detector") {
											if (
													...
													xhtm+='\t      <td id="img"><img src="images/smoke48on.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40"></td>\n';
											}
											else {
													xhtm+='\t      <td id="img"><img src="images/smoke48off.png" onclick="ShowLightLog(' + item.idx + ',\'' + btoa(item.Name)  + '\', \'#dashcontent\', \'ShowFavorites\');" class="lcursor" height="40" width="40"></td>\n';
											}
									}
									else {
										if (
					  ...
					  )
				  {
					...
					var xhtm="";
								if (($scope.config.DashboardType==2)||(window.myglobals.ismobile==true)) {
									...
									xhtm+='" class="lcursor" onclick="ShowTempLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40"></td>\n' +
											'\t      <td id="status">';
									var bHaveBefore=false;
									if (typeof item.HumidityStatus != 'undefined') {
					  ...
					  )
				  {
					...
					var xhtm="";
								if (($scope.config.DashboardType==2)||(window.myglobals.ismobile==true)) {
									...
									xhtm+='\t      <td id="img"><img src="images/';
									if (typeof item.Rain != 'undefined') {
										xhtm+='rain48.png" class="lcursor" onclick="ShowRainLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40"></td>\n' +
										...
										xhtm+='visibility48.png" class="lcursor" onclick="ShowGeneralGraph(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\',' + item.SwitchTypeVal +', \'Visibility\');" height="40" width="40"></td>\n' +
										'\t      <td id="status">' + item.Data;
									}
									else if (typeof item.UVI != 'undefined') {
										xhtm+='uv48.png" class="lcursor" onclick="ShowUVLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40"></td>\n' +
										...
										xhtm+='radiation48.png" class="lcursor" onclick="ShowGeneralGraph(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\',' + item.SwitchTypeVal +', \'Radiation\');" height="40" width="40"></td>\n' +
										'\t      <td id="status">' + item.Data;
									}
									else if (typeof item.Direction != 'undefined') {
										xhtm+='Wind' + item.DirectionStr + '.png" class="lcursor" onclick="ShowWindLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40"></td>\n' +
										...
										xhtm+='baro48.png" class="lcursor" onclick="ShowBaroLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40"></td>\n' +
					...
					if (($scope.config.DashboardType==2)||(window.myglobals.ismobile==true)) {
						...
						if (typeof item.Counter != 'undefined') {
							if ((item.Type == "P1 Smart Meter")&&(item.SubType=="Energy")) {
								xhtm+='counter.png" class="lcursor" onclick="ShowSmartLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\', ' + item.SwitchTypeVal + ');" height="40" width="40"></td>\n';
							}
							else {
								xhtm+='counter.png" class="lcursor" onclick="ShowCounterLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\', ' + item.SwitchTypeVal + ');" height="40" width="40"></td>\n';
							}
							if ((item.SubType!="Gas")&&(item.SubType != "RFXMeter counter")) {
								status='' + $.t("Usage") + ': ' + item.CounterToday;
							}
							...
							xhtm+='current48.png" class="lcursor" onclick="ShowCurrentLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\', ' + item.displaytype + ');" height="40" width="40"></td>\n';
							status=item.Data;
						}
						else if ((item.Type == "Energy")||(item.Type == "Current/Energy")) {
							xhtm+='current48.png" class="lcursor" onclick="ShowCounterLogSpline(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\', ' + item.SwitchTypeVal + ');" height="40" width="40"></td>\n';
							status=item.Data;
						}
						else if (item.Type == "Air Quality") {
							xhtm+='air48.png" class="lcursor" onclick="ShowAirQualityLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40"></td>\n';
							status=item.Data + " (" + item.Quality + ")";
						}
						else if (item.SubType == "Percentage") {
							xhtm+='Percentage48.png" class="lcursor" onclick="ShowPercentageLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40"></td>\n';
							status=item.Data;
						}
						else if (item.Type == "Fan") {
							xhtm+='Fan48_On.png" class="lcursor" onclick="ShowFanLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40"></td>\n';
							status=item.Data;
						}				
						else if (item.Type == "Lux") {
							xhtm+='lux48.png" class="lcursor" onclick="ShowLuxLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\', ' + item.SwitchTypeVal + ');" height="40" width="40"></td>\n';
							status=item.Data;
						}
						else if (item.Type == "Weight") {
							...
							xhtm+='current48.png" class="lcursor" onclick="ShowUsageLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\', ' + item.SwitchTypeVal + ');" height="40" width="40"></td>\n';
							status=item.Data;
						}
						else if (item.SubType=="Soil Moisture") {
							...
							xhtm+='visibility48.png" class="lcursor" onclick="ShowGeneralGraph(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\',' + item.SwitchTypeVal +', \'DistanceGeneral\');" height="40" width="40"></td>\n';
							status=item.Data;
						}
						else if ((item.SubType=="Voltage")||(item.SubType=="Current")||(item.SubType=="A/D")) {
							xhtm+='current48.png" class="lcursor" onclick="ShowGeneralGraph(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\',' + item.SwitchTypeVal +', \'' + item.SubType + '\');" height="40" width="40"></td>\n';
							status=item.Data;
						}
						else if (item.SubType=="Text") {
							xhtm+='text48.png" class="lcursor" onclick="ShowTextLog(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\');" height="40" width="40"></td>\n';
							status=item.Data;
						}
						else if (item.SubType=="Alert") {
							...
							xhtm+='gauge48.png" class="lcursor" onclick="ShowGeneralGraph(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\',' + item.SwitchTypeVal +', \'' + item.SubType + '\');" height="40" width="40"></td>\n';
							status=item.Data;
						}
						else if ((item.Type == "Thermostat")&&(item.SubType=="SetPoint")) {
							...
							xhtm+='Speaker48_On.png" class="lcursor" onclick="ShowGeneralGraph(\'#dashcontent\',\'ShowFavorites\',' + item.idx + ',\'' + btoa(item.Name) + '\',' + item.SwitchTypeVal +', \'' + item.SubType + '\');" height="40" width="40"></td>\n';
							status=item.Data;
						}
