define(['app'], function (app) {
    app.controller('HardwareController', [ '$scope', '$rootScope', '$location', '$http', '$interval', function($scope,$rootScope,$location,$http,$interval) {
        ...
        UpdateHardware= function(idx,Mode1,Mode2,Mode3,Mode4,Mode5,Mode6)
        {
            ...
            else if (text.indexOf("LAN") >= 0 && text.indexOf("YouLess") == -1 && text.indexOf("Integra") == -1 && text.indexOf("ETH8020") == -1 && text.indexOf("Anna") == -1 && text.indexOf("KMTronic") == -1 && text.indexOf("MQTT") == -1 && text.indexOf("Integra") == -1)
            {
            ...
            $("#hardwaretable tbody").on( 'click', 'tr', function () {
                if ( $(this).hasClass('row_selected') ) {
                    ...
                    if ( anSelected.length !== 0 ) {
                        ...
                        else if (((data["Type"].indexOf("LAN") >= 0) && (data["Type"].indexOf("YouLess") == -1) && (data["Type"].indexOf("Integra") == -1)) || (data["Type"].indexOf("Domoticz") >= 0) || (data["Type"].indexOf("Harmony") >= 0)) {
                            $("#hardwarecontent #hardwareparamsremote #tcpaddress").val(data["Address"]);
                            $("#hardwarecontent #hardwareparamsremote #tcpport").val(data["Port"]);
                        }
                        else if (((data["Type"].indexOf("LAN") >= 0) && ((data["Type"].indexOf("YouLess") >= 0) || (data["Type"].indexOf("Integra") >= 0)) || (data["Type"].indexOf("Domoticz") >= 0) || (data["Type"].indexOf("Harmony") >= 0)) {
                            $("#hardwarecontent #hardwareparamsremote #tcpaddress").val(data["Address"]);
                            $("#hardwarecontent #hardwareparamsremote #tcpport").val(data["Port"]);
