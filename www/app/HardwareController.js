    ...
    app.controller("HardwareController", [ "$scope", "$rootScope", "$location", "$http", "$interval", function($scope, $rootScope, $location, $http, $interval) {
        ...
        UpdateHardware = function(idx, Mode1, Mode2, Mode3, Mode4, Mode5, Mode6) {
            ...
            if (!$.isNumeric(hardwaretype)) {
                ...
                if (bIsOK) {
                    $.ajax({
                        url: "json.htm?type=command&param=updatehardware&htype=94" + "&idx=" + idx + "&name=" + encodeURIComponent(name) + "&username=" + encodeURIComponent($(selector + " #Username").length == 0 ? "" : $(selector + " #Username").val()) + "&password=" + encodeURIComponent($(selector + " #Password").length == 0 ? "" : $(selector + " #Password").val()) + "&address=" + encodeURIComponent($(selector + " #Address").length == 0 ? "" : $(selector + " #Address").val()) + "&port=" + encodeURIComponent($(selector + " #Port").length == 0 ? "" : $(selector + " #Port").val()) + "&serialport=" + encodeURIComponent($(selector + " #SerialPort").length == 0 ? "" : $(selector + " #SerialPort").val()) + "&Mode1=" + encodeURIComponent($(selector + " #Mode1").length == 0 ? "" : $(selector + " #Mode1").val()) + "&Mode2=" + encodeURIComponent($(selector + " #Mode2").length == 0 ? "" : $(selector + " #Mode2").val()) + "&Mode3=" + encodeURIComponent($(selector + " #Mode3").length == 0 ? "" : $(selector + " #Mode3").val()) + "&Mode4=" + encodeURIComponent($(selector + " #Mode4").length == 0 ? "" : $(selector + " #Mode4").val()) + "&Mode5=" + encodeURIComponent($(selector + " #Mode5").length == 0 ? "" : $(selector + " #Mode5").val()) + "&Mode6=" + encodeURIComponent($(selector + " #Mode6").length == 0 ? "" : $(selector + " #Mode6").val()) + "&extra=" + encodeURIComponent(hardwaretype) + "&enabled=" + bEnabled + "&datatimeout=" + datatimeout,
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            RefreshHardwareTable();
            ...
            if (text.indexOf("1-Wire") >= 0) {
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&extra=" + encodeURIComponent(extra) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1 + "&Mode2=" + Mode2 + "&Mode3=" + Mode3 + "&Mode4=" + Mode4 + "&Mode5=" + Mode5 + "&Mode6=" + Mode6,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
            ...
            } else if (text.indexOf("Panasonic") >= 0 || text.indexOf("BleBox") >= 0 || text.indexOf("TE923") >= 0 || text.indexOf("Volcraft") >= 0 || text.indexOf("GPIO") >= 0 || text.indexOf("Dummy") >= 0 || text.indexOf("System Alive") >= 0 || text.indexOf("PiFace") >= 0 || text.indexOf("I2C ") >= 0 || text.indexOf("Motherboard") >= 0 || text.indexOf("Kodi Media") >= 0 || text.indexOf("Evohome") >= 0 && text.indexOf("script") >= 0 || text.indexOf("YeeLight") >= 0 || text.indexOf("Arilux AL-LC0x") >= 0) {
                if (hardwaretype == 1e3) {
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1 + "&Mode2=" + Mode2 + "&Mode3=" + Mode3 + "&Mode4=" + Mode4 + "&Mode5=" + Mode5 + "&Mode6=" + Mode6 + port,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&port=" + encodeURIComponent(serialport) + "&extra=" + extra + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1 + "&Mode2=" + Mode2 + "&Mode3=" + Mode3 + "&Mode4=" + Mode4 + "&Mode5=" + Mode5 + "&Mode6=" + Mode6,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
            ...
            } else if (text.indexOf("LAN") >= 0 && text.indexOf("YouLess") == -1 && text.indexOf("Denkovi") == -1 && text.indexOf("Relay-Net") == -1 && text.indexOf("Satel Integra") == -1 && text.indexOf("ETH8020") == -1 && text.indexOf("Daikin") == -1 && text.indexOf("Sterbox") == -1 && text.indexOf("Anna") == -1 && text.indexOf("KMTronic") == -1 && text.indexOf("MQTT") == -1 && text.indexOf("Razberry") == -1 && text.indexOf("MyHome OpenWebNet with LAN interface") == -1) {
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&address=" + address + "&port=" + port + "&extra=" + extra + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1 + "&Mode2=" + Mode2 + "&Mode3=" + Mode3 + "&Mode4=" + Mode4 + "&Mode5=" + Mode5 + "&Mode6=" + Mode6,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
            ...
            } else if (text.indexOf("LAN") >= 0 && (text.indexOf("YouLess") >= 0 || text.indexOf("Denkovi") >= 0) || text.indexOf("Relay-Net") >= 0 || text.indexOf("Satel Integra") >= 0 || text.indexOf("Harmony") >= 0 || text.indexOf("Xiaomi Gateway") >= 0 || text.indexOf("MyHome OpenWebNet with LAN interface") >= 0) {
                var address = $("#hardwarecontent #divremote #tcpaddress").val();
                if (address == "") {
                    ShowNotify($.t("Please enter an Address!"), 2500, true);
                    return;
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&address=" + address + "&port=" + port + "&name=" + encodeURIComponent(name) + "&password=" + encodeURIComponent(password) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1 + "&Mode2=" + Mode2 + "&Mode3=" + Mode3 + "&Mode4=" + Mode4 + "&Mode5=" + Mode5 + "&Mode6=" + Mode6,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
            ...
            } else if (text.indexOf("Domoticz") >= 0 || text.indexOf("ETH8020") >= 0 || text.indexOf("Daikin") >= 0 || text.indexOf("Sterbox") >= 0 || text.indexOf("Anna") >= 0 || text.indexOf("KMTronic") >= 0 || text.indexOf("MQTT") >= 0 || text.indexOf("Razberry") >= 0) {
                var address = $("#hardwarecontent #divremote #tcpaddress").val();
                if (address == "") {
                    ShowNotify($.t("Please enter an Address!"), 2500, true);
                    return;
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&address=" + address + "&port=" + port + "&username=" + encodeURIComponent(username) + "&password=" + encodeURIComponent(password) + "&extra=" + encodeURIComponent(extra) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1 + "&Mode2=" + Mode2 + "&Mode3=" + Mode3 + "&Mode4=" + Mode4 + "&Mode5=" + Mode5 + "&Mode6=" + Mode6,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&address=" + address + "&port=" + port + "&username=" + encodeURIComponent(username) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1 + "&Mode2=" + Mode2 + "&Mode3=" + Mode3 + "&Mode4=" + Mode4 + "&Mode5=" + Mode5 + "&Mode6=" + Mode6,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&port=" + refresh + "&username=" + encodeURIComponent(username) + "&password=" + encodeURIComponent(password) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&address=" + encodeURIComponent(url) + "&extra=" + extra,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&username=" + encodeURIComponent(apikey) + "&password=" + encodeURIComponent(location) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1 + "&Mode2=" + Mode2 + "&Mode3=" + Mode3 + "&Mode4=" + Mode4 + "&Mode5=" + Mode5 + "&Mode6=" + Mode6,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&username=" + encodeURIComponent(apikey) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&username=" + encodeURIComponent(configlocation) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1 + "&Mode2=" + Mode2 + "&Mode3=" + Mode3 + "&Mode4=" + Mode4 + "&Mode5=" + Mode5 + "&Mode6=" + Mode6,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&username=" + encodeURIComponent(username) + "&password=" + encodeURIComponent(password) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&Mode1=" + agreement,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
            ...
            } else if (text.indexOf("ICY") >= 0 || text.indexOf("Atag") >= 0 || text.indexOf("Nest Th") >= 0 || text.indexOf("PVOutput") >= 0 || text.indexOf("Netatmo") >= 0 || text.indexOf("Fitbit") >= 0 || text.indexOf("Thermosmart") >= 0) {
                var username = $("#hardwarecontent #divlogin #username").val();
                var password = encodeURIComponent($("#hardwarecontent #divlogin #password").val());
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&username=" + encodeURIComponent(username) + "&password=" + encodeURIComponent(password) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1 + "&Mode2=" + Mode2 + "&Mode3=" + Mode3 + "&Mode4=" + Mode4 + "&Mode5=" + Mode5 + "&Mode6=" + Mode6,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&name=" + encodeURIComponent(name) + "&address=" + encodeURIComponent(mill_name) + "&port=" + encodeURIComponent(nrofwinddelen) + "&Mode1=" + encodeURIComponent(mill_id) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&Mode2=" + Mode2 + "&Mode3=" + Mode3 + "&Mode4=" + Mode4 + "&Mode5=" + Mode5 + "&Mode6=" + Mode6,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=updatehardware&htype=" + hardwaretype + "&username=" + encodeURIComponent(username) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1 + "&Mode2=" + Mode2 + "&Mode3=" + Mode3 + "&Mode4=" + Mode4 + "&Mode5=" + Mode5 + "&Mode6=" + Mode6,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
        ...
        AddHardware = function() {
            ...
            if (!$.isNumeric(hardwaretype)) {
                ...
                if (bIsOK) {
                    $.ajax({
                        url: "json.htm?type=command&param=addhardware&htype=94" + "&name=" + encodeURIComponent(name) + "&username=" + encodeURIComponent($(selector + " #Username").length == 0 ? "" : $(selector + " #Username").val()) + "&password=" + encodeURIComponent($(selector + " #Password").length == 0 ? "" : $(selector + " #Password").val()) + "&address=" + encodeURIComponent($(selector + " #Address").length == 0 ? "" : $(selector + " #Address").val()) + "&port=" + encodeURIComponent($(selector + " #Port").length == 0 ? "" : $(selector + " #Port").val()) + "&serialport=" + encodeURIComponent($(selector + " #SerialPort").length == 0 ? "" : $(selector + " #SerialPort").val()) + "&Mode1=" + encodeURIComponent($(selector + " #Mode1").length == 0 ? "" : $(selector + " #Mode1").val()) + "&Mode2=" + encodeURIComponent($(selector + " #Mode2").length == 0 ? "" : $(selector + " #Mode2").val()) + "&Mode3=" + encodeURIComponent($(selector + " #Mode3").length == 0 ? "" : $(selector + " #Mode3").val()) + "&Mode4=" + encodeURIComponent($(selector + " #Mode4").length == 0 ? "" : $(selector + " #Mode4").val()) + "&Mode5=" + encodeURIComponent($(selector + " #Mode5").length == 0 ? "" : $(selector + " #Mode5").val()) + "&Mode6=" + encodeURIComponent($(selector + " #Mode6").length == 0 ? "" : $(selector + " #Mode6").val()) + "&extra=" + encodeURIComponent(hardwaretype) + "&enabled=" + bEnabled + "&datatimeout=" + datatimeout,
                        async: false,
                        dataType: "json",
                        success: function(data) {
            ...
            if (text.indexOf("1-Wire") >= 0) {
                ...
                $.ajax({
                    url: "json.htm?type=command&param=addhardware&htype=" + hardwaretype + "&extra=" + encodeURIComponent(owfspath) + "&Mode1=" + oneWireSensorPollPeriod + "&Mode2=" + oneWireSwitchPollPeriod + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&datatimeout=" + datatimeout,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
            ...
            } else if (text.indexOf("LAN") >= 0 && text.indexOf("YouLess") == -1 && text.indexOf("Denkovi") == -1 && text.indexOf("ETH8020") == -1 && text.indexOf("Daikin") == -1 && text.indexOf("Sterbox") == -1 && text.indexOf("Anna") == -1 && text.indexOf("KMTronic") == -1 && text.indexOf("MQTT") == -1 && text.indexOf("Relay-Net") == -1 && text.indexOf("Satel Integra") == -1 && text.indexOf("Razberry") == -1 && text.indexOf("MyHome OpenWebNet with LAN interface") == -1) {
                var address = $("#hardwarecontent #divremote #tcpaddress").val();
                if (address == "") {
                    ShowNotify($.t("Please enter an Address!"), 2500, true);
                    return;
            ...
            } else if (text.indexOf("Panasonic") >= 0 || text.indexOf("BleBox") >= 0 || text.indexOf("TE923") >= 0 || text.indexOf("Volcraft") >= 0 || text.indexOf("Dummy") >= 0 || text.indexOf("System Alive") >= 0 || text.indexOf("Kodi Media") >= 0 || text.indexOf("PiFace") >= 0 || text.indexOf("Evohome") >= 0 && text.indexOf("script") >= 0 || text.indexOf("Tellstick") >= 0 || text.indexOf("Motherboard") >= 0 || text.indexOf("YeeLight") >= 0 || text.indexOf("Arilux AL-LC0x") >= 0) {
                $.ajax({
                ...
                Mode3 = gpiopollinterval;
                $.ajax({
                    url: "json.htm?type=command&param=addhardware&htype=" + hardwaretype + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1 + "&Mode2=" + Mode2 + "&Mode3=" + Mode3,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=addhardware&htype=" + hardwaretype + "&port=" + encodeURIComponent(serialport) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=addhardware&htype=" + hardwaretype + "&address=" + address + "&port=" + port + "&name=" + encodeURIComponent(name) + "&password=" + encodeURIComponent(password) + "&enabled=" + bEnabled + "&datatimeout=" + datatimeout + "&Mode1=" + Mode1 + "&Mode2=" + Mode2 + "&Mode3=" + Mode3 + "&Mode4=" + Mode4 + "&Mode5=" + Mode5,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
            ...
            } else if (text.indexOf("Domoticz") >= 0 || text.indexOf("ETH8020") >= 0 || text.indexOf("Daikin") >= 0 || text.indexOf("Sterbox") >= 0 || text.indexOf("Anna") >= 0 || text.indexOf("KMTronic") >= 0 || text.indexOf("MQTT") >= 0 || text.indexOf("Logitech Media Server") >= 0 || text.indexOf("HEOS by DENON") >= 0 || text.indexOf("Razberry") >= 0) {
                var address = $("#hardwarecontent #divremote #tcpaddress").val();
                if (address == "") {
                    ShowNotify($.t("Please enter an Address!"), 2500, true);
                    return;
                ...
                $.ajax({
                    url: "json.htm?type=command&param=addhardware&htype=" + hardwaretype + "&username=" + encodeURIComponent(configlocation) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&datatimeout=" + datatimeout,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=addhardware&htype=" + hardwaretype + "&name=" + encodeURIComponent(name) + "&address=" + encodeURIComponent(mill_name) + "&port=" + encodeURIComponent(nrofwinddelen) + "&Mode1=" + encodeURIComponent(mill_id) + "&enabled=" + bEnabled + "&datatimeout=" + datatimeout,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=addhardware&htype=" + hardwaretype + "&name=" + encodeURIComponent(name) + "&username=" + encodeURIComponent(apikey) + "&enabled=" + bEnabled + "&idx=" + idx + "&datatimeout=" + datatimeout,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=addhardware&htype=" + hardwaretype + "&username=" + encodeURIComponent(username) + "&password=" + encodeURIComponent(password) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&datatimeout=" + datatimeout + "&Mode1=" + agreement,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
            ...
            } else if (text.indexOf("ICY") >= 0 || text.indexOf("Atag") >= 0 || text.indexOf("Nest Th") >= 0 || text.indexOf("PVOutput") >= 0 || text.indexOf("Netatmo") >= 0 || text.indexOf("Fitbit") >= 0 || text.indexOf("Thermosmart") >= 0 || text.indexOf("HTTP") >= 0) {
                var username = $("#hardwarecontent #divlogin #username").val();
                var password = encodeURIComponent($("#hardwarecontent #divlogin #password").val());
                $.ajax({
                    url: "json.htm?type=command&param=addhardware&htype=" + hardwaretype + "&username=" + encodeURIComponent(username) + "&password=" + encodeURIComponent(password) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&datatimeout=" + datatimeout,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
                ...
                $.ajax({
                    url: "json.htm?type=command&param=addhardware&htype=" + hardwaretype + "&username=" + encodeURIComponent(username) + "&name=" + encodeURIComponent(name) + "&enabled=" + bEnabled + "&datatimeout=" + datatimeout,
                    async: false,
                    dataType: "json",
                    success: function(data) {
                        RefreshHardwareTable();
        ...
        EditRFXCOMMode = function(idx, name, Mode1, Mode2, Mode3, Mode4, Mode5, Mode6) {
            ...
            $("#hardwarecontent #Keeloq").prop("checked", (Mode6 & 1) != 0);
            $("#hardwarecontent #HC").prop("checked", (Mode6 & 2) != 0);
            $("#hardwarecontent #undecon").prop("checked", (Mode3 & 128) != 0);
            $("#hardwarecontent #X10").prop("checked", (Mode5 & 1) != 0);
            $("#hardwarecontent #ARC").prop("checked", (Mode5 & 2) != 0);
            $("#hardwarecontent #AC").prop("checked", (Mode5 & 4) != 0);
            $("#hardwarecontent #HomeEasyEU").prop("checked", (Mode5 & 8) != 0);
            $("#hardwarecontent #Meiantech").prop("checked", (Mode5 & 16) != 0);
            $("#hardwarecontent #OregonScientific").prop("checked", (Mode5 & 32) != 0);
            $("#hardwarecontent #ATIremote").prop("checked", (Mode5 & 64) != 0);
            $("#hardwarecontent #Visonic").prop("checked", (Mode5 & 128) != 0);
            $("#hardwarecontent #Mertik").prop("checked", (Mode4 & 1) != 0);
            $("#hardwarecontent #ADLightwaveRF").prop("checked", (Mode4 & 2) != 0);
            $("#hardwarecontent #HidekiUPM").prop("checked", (Mode4 & 4) != 0);
            $("#hardwarecontent #LaCrosse").prop("checked", (Mode4 & 8) != 0);
            $("#hardwarecontent #FS20").prop("checked", (Mode4 & 16) != 0);
            $("#hardwarecontent #ProGuard").prop("checked", (Mode4 & 32) != 0);
            $("#hardwarecontent #BlindT0").prop("checked", (Mode4 & 64) != 0);
            $("#hardwarecontent #BlindT1T2T3T4").prop("checked", (Mode4 & 128) != 0);
            $("#hardwarecontent #AEBlyss").prop("checked", (Mode3 & 1) != 0);
            $("#hardwarecontent #Rubicson").prop("checked", (Mode3 & 2) != 0);
            $("#hardwarecontent #FineOffsetViking").prop("checked", (Mode3 & 4) != 0);
            $("#hardwarecontent #Lighting4").prop("checked", (Mode3 & 8) != 0);
            $("#hardwarecontent #RSL").prop("checked", (Mode3 & 16) != 0);
            $("#hardwarecontent #ByronSX").prop("checked", (Mode3 & 32) != 0);
            $("#hardwarecontent #ImaginTronix").prop("checked", (Mode3 & 64) != 0);
        ...
        AddWOLNode = function() {
            ...
            $.ajax({
                url: "json.htm?type=command&param=woladdnode" + "&idx=" + $.devIdx + "&name=" + encodeURIComponent(name) + "&mac=" + mac,
                async: false,
                dataType: "json",
                success: function(data) {
                    RefreshWOLNodeTable();
        ...
        WOLDeleteNode = function(nodeid) {
            ...
            bootbox.confirm($.t("Are you sure to remove this Node?"), function(result) {
                if (result == true) {
                    $.ajax({
                        url: "json.htm?type=command&param=wolremovenode" + "&idx=" + $.devIdx + "&nodeid=" + nodeid,
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            RefreshWOLNodeTable();
        ...
        WOLClearNodes = function() {
            bootbox.confirm($.t("Are you sure to delete ALL Nodes?\n\nThis action can not be undone!"), function(result) {
                if (result == true) {
                    $.ajax({
                        url: "json.htm?type=command&param=wolclearnodes" + "&idx=" + $.devIdx,
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            RefreshWOLNodeTable();
        ...
        WOLUpdateNode = function(nodeid) {
            ...
            $.ajax({
                url: "json.htm?type=command&param=wolupdatenode" + "&idx=" + $.devIdx + "&nodeid=" + nodeid + "&name=" + encodeURIComponent(name) + "&mac=" + mac,
                async: false,
                dataType: "json",
                success: function(data) {
                    RefreshWOLNodeTable();
        ...
        AddPingerNode = function() {
            ...
            $.ajax({
                url: "json.htm?type=command&param=pingeraddnode" + "&idx=" + $.devIdx + "&name=" + encodeURIComponent(name) + "&ip=" + ip + "&timeout=" + Timeout,
                async: false,
                dataType: "json",
                success: function(data) {
        ...
        PingerDeleteNode = function(nodeid) {
            ...
            bootbox.confirm($.t("Are you sure to remove this Node?"), function(result) {
                if (result == true) {
                    $.ajax({
                        url: "json.htm?type=command&param=pingerremovenode" + "&idx=" + $.devIdx + "&nodeid=" + nodeid,
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            RefreshPingerNodeTable();
        ...
        PingerClearNodes = function() {
            bootbox.confirm($.t("Are you sure to delete ALL Nodes?\n\nThis action can not be undone!"), function(result) {
                if (result == true) {
                    $.ajax({
                        url: "json.htm?type=command&param=pingerclearnodes" + "&idx=" + $.devIdx,
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            RefreshPingerNodeTable();
        ...
        PingerUpdateNode = function(nodeid) {
            ...
            if (Timeout < 1) Timeout = 5;
            $.ajax({
                url: "json.htm?type=command&param=pingerupdatenode" + "&idx=" + $.devIdx + "&nodeid=" + nodeid + "&name=" + encodeURIComponent(name) + "&ip=" + ip + "&timeout=" + Timeout,
                async: false,
                dataType: "json",
                success: function(data) {
                    RefreshPingerNodeTable();
        ...
        SetPingerSettings = function() {
            ...
            if (Mode2 < 500) Mode2 = 500;
            $.ajax({
                url: "json.htm?type=command&param=pingersetmode" + "&idx=" + $.devIdx + "&mode1=" + Mode1 + "&mode2=" + Mode2,
                async: false,
                dataType: "json",
                success: function(data) {
        ...
        MySensorsUpdateNode = function(nodeid) {
            ...
            $.ajax({
                url: "json.htm?type=command&param=mysensorsupdatenode" + "&idx=" + $.devIdx + "&nodeid=" + nodeid + "&name=" + encodeURIComponent(name),
                async: false,
                dataType: "json",
                success: function(data) {
        ...
        MySensorsDeleteNode = function(nodeid) {
            ...
            bootbox.confirm($.t("Are you sure to remove this Node?"), function(result) {
                if (result == true) {
                    $.ajax({
                        url: "json.htm?type=command&param=mysensorsremovenode" + "&idx=" + $.devIdx + "&nodeid=" + nodeid,
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            RefreshMySensorsNodeTable();
        ...
        MySensorsDeleteChild = function(nodeid, childid) {
            ...
            bootbox.confirm($.t("Are you sure to remove this Child?"), function(result) {
                if (result == true) {
                    $.ajax({
                        url: "json.htm?type=command&param=mysensorsremovechild" + "&idx=" + $.devIdx + "&nodeid=" + nodeid + "&childid=" + childid,
                        async: false,
                        dataType: "json",
                        success: function(data) {
        ...
        MySensorsUpdateChild = function(nodeid, childid) {
            ...
            if (AckTimeout < 100) AckTimeout = 100; else if (AckTimeout > 1e4) AckTimeout = 1e4;
            $.ajax({
                url: "json.htm?type=command&param=mysensorsupdatechild" + "&idx=" + $.devIdx + "&nodeid=" + nodeid + "&childid=" + childid + "&useack=" + bUseAck + "&acktimeout=" + AckTimeout,
                async: false,
                dataType: "json",
                success: function(data) {
                    MySensorsRefreshActiveDevicesTable();
        ...
        MySensorsRefreshActiveDevicesTable = function() {
            ...
            $.ajax({
                url: "json.htm?type=command&param=mysensorsgetchilds" + "&idx=" + $.devIdx + "&nodeid=" + $.nodeid,
                async: false,
                dataType: "json",
                success: function(data) {
                    if (typeof data.result != "undefined") {
        ...
        AddKodiNode = function() {
            ...
            $.ajax({
                url: "json.htm?type=command&param=kodiaddnode" + "&idx=" + $.devIdx + "&name=" + encodeURIComponent(name) + "&ip=" + ip + "&port=" + Port,
                async: false,
                dataType: "json",
                success: function(data) {
        ...
        KodiDeleteNode = function(nodeid) {
            ...
            bootbox.confirm($.t("Are you sure to remove this Node?"), function(result) {
                if (result == true) {
                    $.ajax({
                        url: "json.htm?type=command&param=kodiremovenode" + "&idx=" + $.devIdx + "&nodeid=" + nodeid,
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            RefreshKodiNodeTable();
        ...
        KodiClearNodes = function() {
            bootbox.confirm($.t("Are you sure to delete ALL Nodes?\n\nThis action can not be undone!"), function(result) {
                if (result == true) {
                    $.ajax({
                        url: "json.htm?type=command&param=kodiclearnodes" + "&idx=" + $.devIdx,
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            RefreshKodiNodeTable();
        ...
        KodiUpdateNode = function(nodeid) {
            ...
            $.ajax({
                url: "json.htm?type=command&param=kodiupdatenode" + "&idx=" + $.devIdx + "&nodeid=" + nodeid + "&name=" + encodeURIComponent(name) + "&ip=" + ip + "&port=" + Port,
                async: false,
                dataType: "json",
                success: function(data) {
                    RefreshKodiNodeTable();
        ...
        SetKodiSettings = function() {
            ...
            if (Mode2 < 500) Mode2 = 500;
            $.ajax({
                url: "json.htm?type=command&param=kodisetmode" + "&idx=" + $.devIdx + "&mode1=" + Mode1 + "&mode2=" + Mode2,
                async: false,
                dataType: "json",
                success: function(data) {
                    bootbox.alert($.t("Settings saved"));
        ...
        PanasonicAddNode = function() {
            ...
            $.ajax({
                url: "json.htm?type=command&param=panasonicaddnode" + "&idx=" + $.devIdx + "&name=" + encodeURIComponent(name) + "&ip=" + ip + "&port=" + Port,
                async: false,
                dataType: "json",
                success: function(data) {
        ...
        PanasonicDeleteNode = function(nodeid) {
            ...
            bootbox.confirm($.t("Are you sure to remove this Node?"), function(result) {
                if (result == true) {
                    $.ajax({
                        url: "json.htm?type=command&param=panasonicremovenode" + "&idx=" + $.devIdx + "&nodeid=" + nodeid,
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            RefreshPanasonicNodeTable();
        ...
        PanasonicClearNodes = function() {
            bootbox.confirm($.t("Are you sure to delete ALL Nodes?\n\nThis action can not be undone!"), function(result) {
                if (result == true) {
                    $.ajax({
                        url: "json.htm?type=command&param=panasonicclearnodes" + "&idx=" + $.devIdx,
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            RefreshPanasonicNodeTable();
        ...
        PanasonicUpdateNode = function(nodeid) {
            ...
            $.ajax({
                url: "json.htm?type=command&param=panasonicupdatenode" + "&idx=" + $.devIdx + "&nodeid=" + nodeid + "&name=" + encodeURIComponent(name) + "&ip=" + ip + "&port=" + Port,
                async: false,
                dataType: "json",
                success: function(data) {
                    RefreshPanasonicNodeTable();
        ...
        SetPanasonicSettings = function() {
            ...
            if (Mode2 < 500) Mode2 = 500;
            $.ajax({
                url: "json.htm?type=command&param=panasonicsetmode" + "&idx=" + $.devIdx + "&mode1=" + Mode1 + "&mode2=" + Mode2,
                async: false,
                dataType: "json",
                success: function(data) {
                    bootbox.alert($.t("Settings saved"));
        ...
        BleBoxAddNode = function() {
            ...
            $.ajax({
                url: "json.htm?type=command&param=bleboxaddnode" + "&idx=" + $.devIdx + "&name=" + encodeURIComponent(name) + "&ip=" + ip,
                async: false,
                dataType: "json",
                success: function(data) {
        ...
        BleBoxDeleteNode = function(nodeid) {
            ...
            bootbox.confirm($.t("Are you sure to remove this Node?"), function(result) {
                if (result == true) {
                    $.ajax({
                        url: "json.htm?type=command&param=bleboxremovenode" + "&idx=" + $.devIdx + "&nodeid=" + nodeid,
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            RefreshBleBoxNodeTable();
        ...
        BleBoxClearNodes = function() {
            bootbox.confirm($.t("Are you sure to delete ALL Nodes?\n\nThis action can not be undone!"), function(result) {
                if (result == true) {
                    $.ajax({
                        url: "json.htm?type=command&param=bleboxclearnodes" + "&idx=" + $.devIdx,
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            RefreshBleBoxNodeTable();
        ...
        BleBoxAutoSearchingNodes = function() {
            ...
            $.ajax({
                url: "json.htm?type=command&param=bleboxautosearchingnodes" + "&idx=" + $.devIdx + "&ipmask=" + ipmask,
                async: false,
                dataType: "json",
                success: function(data) {
                    RefreshBleBoxNodeTable();
        ...
        BleBoxUpdateFirmware = function() {
            ...
            $.ajax({
                url: "json.htm?type=command&param=bleboxupdatefirmware" + "&idx=" + $.devIdx,
                async: false,
                dataType: "json",
                success: function(data) {
                    RefreshBleBoxNodeTable();
        ...
        BleBoxUpdateNode = function(nodeid) {
            ...
            $.ajax({
                url: "json.htm?type=command&param=bleboxupdatenode" + "&idx=" + $.devIdx + "&nodeid=" + nodeid + "&name=" + encodeURIComponent(name) + "&ip=" + ip,
                async: false,
                dataType: "json",
                success: function(data) {
                    RefreshBleBoxNodeTable();
        ...
        SetBleBoxSettings = function() {
            ...
            if (Mode2 < 1e3) Mode2 = 1e3;
            $.ajax({
                url: "json.htm?type=command&param=bleboxsetmode" + "&idx=" + $.devIdx + "&mode1=" + Mode1 + "&mode2=" + Mode2,
                async: false,
                dataType: "json",
                success: function(data) {
                    bootbox.alert($.t("Settings saved"));
        ...
        SetLMSSettings = function() {
            ...
            if (Mode2 < 500) Mode2 = 500;
            $.ajax({
                url: "json.htm?type=command&param=lmssetmode" + "&idx=" + $.devIdx + "&mode1=" + Mode1 + "&mode2=" + Mode2,
                async: false,
                dataType: "json",
                success: function(data) {
                    bootbox.alert($.t("Settings saved"));
        ...
        UpdateNode = function(idx) {
            ...
            $.ajax({
                url: "json.htm?type=command&param=updatezwavenode" + "&idx=" + idx + "&name=" + encodeURIComponent(name) + "&EnablePolling=" + bEnablePolling,
                async: false,
                dataType: "json",
                success: function(data) {
                    RefreshOpenZWaveNodeTable();
        ...
        ApplyZWaveConfiguration = function(idx) {
            ...
            if (typeof $list != "undefined") {
                ...
                $list.each(function() {
                    var id = $(this).prop("id");
                    var value = encodeURIComponent(btoa($(this).prop("value")));
            ...
            if (typeof $list != "undefined") {
                ...
                $list.each(function() {
                    var id = $(this).prop("id");
                    var value = encodeURIComponent(btoa($(this).find(":selected").text()));
                    valueList += id + "_" + value + "_";
                });
            }
            if (valueList != "") {
                $.ajax({
                    url: "json.htm?type=command&param=applyzwavenodeconfig" + "&idx=" + idx + "&valuelist=" + valueList,
                    async: false,
                    dataType: "json",
                    success: function(data) {
        ...
        ZWaveTopology = function() {
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == "OK") {
                        noty({
                            text: "<center>" + $.t("ZWave Network Information") + '</center><p><p><iframe src="zwavetopology.html?hwid=' + $.devIdx + '" name="topoframe" frameBorder="0" height="' + window.innerHeight * .7 + '" width="100%"/>',
                            type: "alert",
                            modal: true,
                            buttons: [ {
        ...
        SendOTGWCommand = function() {
            ...
            $.ajax({
                url: "json.htm?type=command&param=sendopenthermcommand" + "&idx=" + idx + "&cmnd=" + cmnd,
                async: false,
                dataType: "json",
                success: function(data) {},
                error: function() {}
        ...
        BindEvohome = function(idx, name, devtype) {
            $.devIdx = idx;
            if (devtype == "Relay") ShowNotify($.t("Hold bind button on relay..."), 2500); else if (devtype == "AllSensors") ShowNotify($.t("Creating additional sensors...")); else if (devtype == "ZoneSensor") ShowNotify($.t("Binding Domoticz zone temperature sensor to controller..."), 2500); else ShowNotify($.t("Binding Domoticz outdoor temperature device to evohome controller..."), 2500);
            setTimeout(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (typeof data.status != "undefined") {
                            bIsUsed = data.Used;
                            if (data.status == "OK") bNewDevice = true; else Name = data.Name;
                        }
                    }
                });
                HideNotify();
                setTimeout(function() {
                    if (bNewDevice == true && bIsUsed == false) {
                        if (devtype == "Relay") ShowNotify($.t("Relay bound, and can be found in the devices tab!"), 2500); else if (devtype == "AllSensors") ShowNotify($.t("New sensors will appear in the devices tab after 10min"), 2500); else if (devtype == "ZoneSensor") ShowNotify($.t("Sensor bound, and can be found in the devices tab!"), 2500); else ShowNotify($.t("Domoticz outdoor temperature device has been bound to evohome controller"), 2500);
                    } else {
                        if (bIsUsed == true) ShowNotify($.t("Already used by") + ':<br>"' + Name + '"', 3500, true); else ShowNotify($.t("Timeout...<br>Please try again!"), 2500, true);
                    }
                }, 200);
            }, 600);
        };
            ...
            $("#dialog-createrflinkdevice").dialog({
                ...
                buttons: {
                    OK: function() {
                        ...
                        $.ajax({
                            url: "json.htm?type=createrflinkdevice&idx=" + $.devIdx + "&command=" + SensorName,
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                if (data.status == "OK") {
            ...
            $("#dialog-createsensor").dialog({
                ...
                buttons: {
                    OK: function() {
                        ...
                        $.ajax({
                            url: "json.htm?type=createvirtualsensor&idx=" + $.devIdx + "&sensorname=" + encodeURIComponent(SensorName) + "&sensortype=" + SensorType + extraSendData,
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                if (data.status == "OK") {
            ...
            $("#dialog-addyeelight").dialog({
                ...
                buttons: {
                    OK: function() {
                        ...
                        $(this).dialog("close");
                        $.ajax({
                            url: "json.htm?type=command&param=addyeelight&idx=" + $.devIdx + "&name=" + encodeURIComponent(SensorName) + "&ipaddress=" + encodeURIComponent(IPAddress) + "&stype=" + SensorType,
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                if (data.status == "OK") {
            ...
            $("#dialog-addArilux").dialog({
                ...
                buttons: {
                    OK: function() {
                        ...
                        $(this).dialog("close");
                        $.ajax({
                            url: "json.htm?type=command&param=addArilux&idx=" + $.devIdx + "&name=" + encodeURIComponent(SensorName) + "&ipaddress=" + encodeURIComponent(IPAddress) + "&stype=" + SensorType,
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                if (data.status == "OK") {
        ...
        TellstickApplySettings = function() {
            ...
            if (repeatInterval < 10) repeatInterval = 10;
            if (repeatInterval > 2e3) repeatInterval = 2e3;
            $.ajax({
                url: "json.htm?type=command&param=tellstickApplySettings" + "&idx=" + $.idx + "&repeats=" + repeats + "&repeatInterval=" + repeatInterval,
                async: false,
                dataType: "json",
                success: function(data) {
                    bootbox.alert($.t("Settings saved"));
                    ...
                    if (typeof data.result != "undefined") {
                        $.each(data.result, function(i, item) {
                            ...
                            if (HwTypeStr.indexOf("RFXCOM") >= 0) {
                                ...
                                if (HwTypeStr.indexOf("script") >= 0) HwTypeStr += ' <span class="label label-info lcursor" onclick="CreateEvohomeSensors(' + item.idx + ",'" + item.Name + "');\">" + $.t("Create Devices") + "</span>"; else {
            ...
            $("#hardwaretable tbody").on("click", "tr", function() {
                if ($(this).hasClass("row_selected")) {
                    ...
                    if (anSelected.length !== 0) {
                        ...
                        if (data["Type"] != "PLUGIN") $("#hardwarecontent #hardwareparamstable #combotype").val(jQuery.inArray(data["Type"], $.myglobals.HardwareTypesStr)); else $("#hardwarecontent #hardwareparamstable #combotype").val(data["Extra"]);
                        ...
                        if (data["Type"].indexOf("I2C ") >= 0) {
                            $("#hardwarecontent #hardwareparamstable #combotype").val(1e3);
                        }
                        $.devExtra = data["Extra"];
                        UpdateHardwareParamControls();
                        if (data["Type"].indexOf("TE923") >= 0 || data["Type"].indexOf("Volcraft") >= 0 || data["Type"].indexOf("Dummy") >= 0 || data["Type"].indexOf("System Alive") >= 0 || data["Type"].indexOf("PiFace") >= 0 || data["Type"].indexOf("Tellstick") >= 0 || data["Type"].indexOf("Yeelight") >= 0 || data["Type"].indexOf("Arilux AL-LC0x") >= 0) {} else if (data["Type"].indexOf("1-Wire") >= 0) {
                        ...
                        if (data["Type"].indexOf("Domoticz") >= 0 || data["Type"].indexOf("ICY") >= 0 || data["Type"].indexOf("Toon") >= 0 || data["Type"].indexOf("Atag") >= 0 || data["Type"].indexOf("Nest Th") >= 0 || data["Type"].indexOf("PVOutput") >= 0 || data["Type"].indexOf("ETH8020") >= 0 || data["Type"].indexOf("Daikin") >= 0 || data["Type"].indexOf("Sterbox") >= 0 || data["Type"].indexOf("Anna") >= 0 || data["Type"].indexOf("KMTronic") >= 0 || data["Type"].indexOf("MQTT") >= 0 || data["Type"].indexOf("Netatmo") >= 0 || data["Type"].indexOf("Fitbit") >= 0 || data["Type"].indexOf("HTTP") >= 0 || data["Type"].indexOf("Thermosmart") >= 0 || data["Type"].indexOf("Logitech Media Server") >= 0 || data["Type"].indexOf("HEOS by DENON") >= 0 || data["Type"].indexOf("Razberry") >= 0 || data["Type"].indexOf("Comm5") >= 0) {
        ...
        RegisterPhilipsHue = function() {
            ...
            var username = $("#hardwarecontent #hardwareparamsphilipshue #username").val();
            $.ajax({
                url: "json.htm?type=command&param=registerhue" + "&ipaddress=" + address + "&port=" + port + "&username=" + encodeURIComponent(username),
                async: false,
                dataType: "json",
                success: function(data) {
                    if (data.status == "ERR") {
        ...
        UpdateHardwareParamControls = function() {
            ...
            if (text.indexOf("TE923") >= 0 || text.indexOf("Volcraft") >= 0 || text.indexOf("Dummy") >= 0 || text.indexOf("System Alive") >= 0 || text.indexOf("PiFace") >= 0 || text.indexOf("Yeelight") >= 0 || text.indexOf("Arilux AL-LC0x") >= 0) {
                ...
                if (text.indexOf("Satel Integra") >= 0) {
                    ...
                    $("#hardwarecontent #hardwareparamspollinterval #pollinterval").val(1e3);
                }
                if (text.indexOf("MyHome OpenWebNet with LAN interface") >= 0) {
                    $("#hardwarecontent #hardwareparamsremote #tcpport").val(2e4);
                }
                ...
                $("#hardwarecontent #divremote").show();
                $("#hardwarecontent #divlogin").show();
                $("#hardwarecontent #hardwareparamsremote #tcpport").val(9e3);
            } else if (text.indexOf("HEOS by DENON") >= 0) {
                $("#hardwarecontent #divserial").hide();
                $("#hardwarecontent #divremote").show();
                $("#hardwarecontent #divlogin").show();
            ...
            if (text.indexOf("ETH8020") >= 0 || text.indexOf("Daikin") >= 0 || text.indexOf("Sterbox") >= 0 || text.indexOf("Anna") >= 0 || text.indexOf("MQTT") >= 0 || text.indexOf("KMTronic Gateway with LAN") >= 0 || text.indexOf("Razberry") >= 0) {
                $("#hardwarecontent #divlogin").show();
            }
            if (text.indexOf("MySensors Gateway with MQTT") >= 0) {
            ...
            if (!$.isNumeric($("#hardwarecontent #hardwareparamstable #combotype option:selected").val())) {
                ...
                $("#hardwarecontent #divpythonplugin .plugin").each(function() {
                    if ($(this).attr("id") === plugin) $(this).show();
                });
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (typeof data.result != "undefined") {
                        ...
                        $.each(data.result, function(i, item) {
                            ...
                            if (item.idx != 94) {
                                ...
                                if (item.wikiURL.length > 0) {
                                    PluginParams += '<tr><td align="right" style="width:110px"><span data-i18n="Wiki URL">Wiki URL</span>:</td>' + '<td><a href="' + item.wikiURL + '">' + item.wikiURL + "</a></td></tr>";
                                }
                                if (item.externalURL.length > 0) {
                                    PluginParams += '<tr><td align="right" style="width:110px"><span data-i18n="Product URL">Product URL</span>:</td>' + '<td><a href="' + item.externalURL + '">' + item.externalURL + "</a></td></tr>";
                                }
                        ...
                        var option = $("<option />");
                        option.attr("value", 1e3).text("I2C sensors");
