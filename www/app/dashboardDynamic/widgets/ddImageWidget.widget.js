define([
    ...
    widgetRegistry.register({
        ...
        configSchema: [
            ...
            { key: 'refreshInterval', type: 'number', step: 1, label: 'Refresh every N seconds (0=off)', default: 0 },
            { key: 'showBackground', type: 'boolean', label: 'Show panel background', default: true }
        ]
    });

    app.directive('ddImageWidget', ['$sce', '$interval', function($sce, $interval) {
        return {
            restrict:         'E',
            templateUrl:      'views/dashboardDynamic/widgets/image-widget.html',
            scope: {
                widgetDef: '=',
                editMode:  '<'
            },
