define(['app'], function (app) {
	...
	app.component('roomPlansTable', {
		...
		controller: function ($element, $scope, $uibModal, $timeout, bootbox, dzRoomPlanApi, dataTableDefaultSettings) {
			...
			function actionsRenderer() {
				var actions = [];
				actions.push('<button class="btn btn-icon js-rename" title="' + $.t('Rename') + '"><i class="fa-solid fa-pen-to-square dz-chrome-icon dz-act-edit"></i></button>');
				actions.push('<button class="btn btn-icon js-remove" title="' + $.t('Remove') + '"><i class="fa-solid fa-trash-can dz-chrome-icon dz-act-danger"></i></button>');
				return actions.join('&nbsp;');
			}
		}
	});
	...
	'</div>',
		controller: function($element, $scope, $q, bootbox, dzRoomPlanApi, dataTableDefaultSettings) {
			...
			function actionsRenderer() {
				return '<button class="btn btn-icon js-remove" title="' + $.t('Remove') + '"><i class="fa-solid fa-trash-can dz-chrome-icon dz-act-danger"></i></button>';
			}
		}
	});
