define([ "app" ], function(app) {
    app.controller("TemperatureCustomLogController", [ "$routeParams", "$scope", "$location", function($routeParams, $scope, $location) {
        var ctrl = this;
        ctrl.init = function() {
            $("#modal").show();
            $("#bannav").i18n();
            ...
            $.CustomChart.highcharts({
                ...
                colors: [ "#FF99CC", "#FFCC99", "#FFFF99", "#CCFFCC", "#CCFFFF", "#99CCFF", "#CC99FF", "#FFFFFF", "#9999FF", "#993366", "#FFFFCC", "#CCFFFF", "#660066", "#FF8080", "#0066CC", "#CCCCFF", "#000080", "#FF00FF", "#FFFF00", "#00FFFF", "#800080", "#800000", "#008080", "#0000FF", "#00C0C0", "#993300", "#333300", "#003300", "#003366", "#000080", "#333399", "#333333", "#800000", "#FF6600", "#808000", "#008000", "#008080", "#0000FF", "#666699", "#808080", "#FF0000", "#FF9900", "#99CC00", "#339966", "#33CCCC", "#3366FF", "#800080", "#969696", "#FF00FF", "#FFCC00", "#FFFF00", "#00FF00", "#00FFFF", "#00CCFF", "#993366", "#C0C0C0" ],
                loading: {
                    hideDuration: 1e3,
                    showDuration: 1e3
                },
        ...
        AddDeviceToGraph = function(cb) {
            if (cb.checked == true) {
                $.ajax({
                    url: "json.htm?type=graph&sensor=temp&idx=" + cb.id + "&range=" + $("#customlog #graphfrom").val() + "T" + $("#customlog #graphto").val() + "&graphtype=" + $("#customlog #combocustomgraphtype").val() + "&graphTemp=" + $("#customlog #graphTemp").prop("checked") + "&graphChill=" + $("#customlog #graphChill").prop("checked") + "&graphHum=" + $("#customlog #graphHum").prop("checked") + "&graphBaro=" + $("#customlog #graphBaro").prop("checked") + "&graphDew=" + $("#customlog #graphDew").prop("checked") + "&graphSet=" + $("#customlog #graphSet").prop("checked"),
                    async: false,
                    dataType: "json",
                    success: function(data) {
        ...
        ctrl.datePickerChanged = function(dpicker) {
            ...
            $('div[id="devicecontainer"] input:checkbox:checked').each(function() {
                ...
                $.ajax({
                    url: "json.htm?type=graph&sensor=temp&idx=" + $(this).attr("id") + "&range=" + $("#customlog #graphfrom").val() + "T" + $("#customlog #graphto").val() + "&graphtype=" + $("#customlog #combocustomgraphtype").val() + "&graphTemp=" + $("#customlog #graphTemp").prop("checked") + "&graphChill=" + $("#customlog #graphChill").prop("checked") + "&graphHum=" + $("#customlog #graphHum").prop("checked") + "&graphBaro=" + $("#customlog #graphBaro").prop("checked") + "&graphDew=" + $("#customlog #graphDew").prop("checked") + "&graphSet=" + $("#customlog #graphSet").prop("checked"),
                    async: false,
                    dataType: "json",
