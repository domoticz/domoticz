                    ...
                    if (typeof data.result != "undefined") {
                        $.each(data.result, function(i, item) {
                            ...
                            if (TypeImg.indexOf("Alert") == 0) {
                                ...
                                if (item.Status == "On" || item.Status == "Mixed") {
                            ...
                            if (item.Type == "Group" || item.Type == "Scene") {
                                ...
                                if (item.Used != 0) {
                                    ...
                                    if (item.Type.indexOf("Light") == 0 || item.Type.indexOf("Security") == 0) {
                            ...
                            if (item.Type.indexOf("Light") == 0 || item.Type.indexOf("Chime") == 0 || item.Type.indexOf("Security") == 0 || item.Type.indexOf("RFY") == 0 || item.Type.indexOf("ASA") == 0 || item.Type.indexOf("Blinds") == 0) {
                            ...
                            var addId = oTable.fnAddData([ itemChecker + "&nbsp;&nbsp;" + itemImage, item.idx, item.HardwareName, ID, item.Unit, item.Name, item.Type, item.SubType, item.Data, item.SignalLevel, BatteryLevel, itemSubIcons, item.LastUpdate ], false);
                        });
                        mTable.fnDraw();
                    }
                },
