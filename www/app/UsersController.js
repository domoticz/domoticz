define([ "app" ], function(app) {
    app.controller("UsersController", [ "$scope", "$rootScope", "$location", "$http", "$interval", "md5", function($scope, $rootScope, $location, $http, $interval, md5) {
        ...
        UpdateUser = function(idx) {
            ...
            $.ajax({
                url: "json.htm?type=command&param=updateuser&idx=" + idx + "&enabled=" + csettings.bEnabled + "&username=" + csettings.username + "&password=" + csettings.password + "&rights=" + csettings.rights + "&RemoteSharing=" + csettings.bEnableSharing + "&TabsEnabled=" + csettings.TabsEnabled,
                async: false,
                dataType: "json",
                success: function(data) {
                    RefreshUserTable();
        ...
        SaveUserDevices = function() {
            var selecteddevices = $("#usercontent .multiselect option:selected").map(function() {
                return this.value;
            }).get().join(";");
            $.ajax({
        ...
        AddUser = function() {
            ...
            $.ajax({
                url: "json.htm?type=command&param=adduser&enabled=" + csettings.bEnabled + "&username=" + csettings.username + "&password=" + csettings.password + "&rights=" + csettings.rights + "&RemoteSharing=" + csettings.bEnableSharing + "&TabsEnabled=" + csettings.TabsEnabled,
                async: false,
                dataType: "json",
                success: function(data) {
                    if (data.status != "OK") {
