				...
				$.each(data.result, function(i,item){
					...
					if (typeof obj != 'undefined') {
					    ...
					    if ((item.Status != 'Off') && (item.Status != '0')) {
					        ...
					        img2 = '<img src="images/remote48.png" onclick="ShowMediaRemote(\'' + encodeURIComponent(item.Name) + "'," +  item.idx + ');" class="lcursor" height="48" width="48">';
					    }
					    else {
				  ...
				  if (item.SubType=="Security Panel") {
					...
					bAddTimer=false;
				      ...
				      if ((item.Status != 'Off') && (item.Status != '0')) {
				          ...
				          xhtm += '\t      <td id="img2"><img src="images/remote48.png" onclick="ShowMediaRemote(\'' + encodeURIComponent(item.Name) + "'," +  item.idx + ');" class="lcursor" height="48" width="48"></td>\n';
                      }
				      else {
