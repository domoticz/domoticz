    ...
    app.controller("UtilityController", [ "$scope", "$rootScope", "$location", "$http", "$interval", "permissions", function($scope, $rootScope, $location, $http, $interval, permissions) {
        ...
        GetSetpointTimerSettings = function() {
            ...
            if (everyday == true) tsettings.days = 128; else if (weekdays == true) tsettings.days = 256; else if (weekends == true) tsettings.days = 512; else {
                if ($("#utilitycontent #timerparamstable #ChkMon").is(":checked")) tsettings.days |= 1;
                if ($("#utilitycontent #timerparamstable #ChkTue").is(":checked")) tsettings.days |= 2;
                if ($("#utilitycontent #timerparamstable #ChkWed").is(":checked")) tsettings.days |= 4;
                if ($("#utilitycontent #timerparamstable #ChkThu").is(":checked")) tsettings.days |= 8;
                if ($("#utilitycontent #timerparamstable #ChkFri").is(":checked")) tsettings.days |= 16;
                if ($("#utilitycontent #timerparamstable #ChkSat").is(":checked")) tsettings.days |= 32;
                if ($("#utilitycontent #timerparamstable #ChkSun").is(":checked")) tsettings.days |= 64;
            }
        ...
        UpdateSetpointTimer = function(idx) {
            ...
            $.ajax({
                url: "json.htm?type=command&param=updatesetpointtimer&idx=" + idx + "&active=" + tsettings.Active + "&timertype=" + tsettings.timertype + "&date=" + tsettings.date + "&hour=" + tsettings.hour + "&min=" + tsettings.min + "&tvalue=" + tsettings.tvalue + "&days=" + tsettings.days + "&mday=" + tsettings.mday + "&month=" + tsettings.month + "&occurence=" + tsettings.occurence,
                async: false,
                dataType: "json",
                success: function(data) {
                    RefreshSetpointTimerTable($.devIdx);
        ...
        AddSetpointTimer = function() {
            ...
            $.ajax({
                url: "json.htm?type=command&param=addsetpointtimer&idx=" + $.devIdx + "&active=" + tsettings.Active + "&timertype=" + tsettings.timertype + "&date=" + tsettings.date + "&hour=" + tsettings.hour + "&min=" + tsettings.min + "&tvalue=" + tsettings.tvalue + "&days=" + tsettings.days + "&mday=" + tsettings.mday + "&month=" + tsettings.month + "&occurence=" + tsettings.occurence,
                async: false,
                dataType: "json",
                success: function(data) {
                    RefreshSetpointTimerTable($.devIdx);
                ...
                if ($(this).hasClass("row_selected")) {
                    ...
                    if (anSelected.length !== 0) {
                        ...
                        if (data["Days"] == "Everyday") {
                            ...
                            disableDays = true;
                        } else $("#utilitycontent #timerparamstable #when_4").prop("checked", "checked");
        ...
        EditMeterDevice = function(idx, name, description, switchtype, meteroffset, valuequantity, valueunits) {
            ...
            $("#dialog-editmeterdevice #combometertype").change(function() {
                ...
                if (meterType == 3) {
                    if ($("#dialog-editmeterdevice #valuequantity").val() == "" && $("#dialog-editmeterdevice #valueunits").val() == "") {
                    ...
                    if (typeof data.result != "undefined") {
                        ...
                        $.each(data.result, function(i, item) {
                            ...
                            if (item.ShowNotifications == true) {
                                if (permissions.hasPermission("Admin")) {
                                    if (item.Notifications == "true") xhtm += '<a class="btnsmall-sel" onclick="ShowNotifications(' + item.idx + ",'" + escape(item.Name) + "', '#utilitycontent', 'ShowUtilities');\" data-i18n=\"Notifications\">Notifications</a>"; else xhtm += '<a class="btnsmall" onclick="ShowNotifications(' + item.idx + ",'" + escape(item.Name) + "', '#utilitycontent', 'ShowUtilities');\" data-i18n=\"Notifications\">Notifications</a>";
                                }
                            }
                            xhtm += "</td>\n" + "	    </tr>\n" + "	    </table>\n" + "	  </section>\n" + "	</div>\n";
                            htmlcontent += xhtm;
        ...
        function init() {
            ...
            dialog_editutilitydevice_buttons[$.t("Update")] = function() {
                ...
                if (bValid) {
                    $(this).dialog("close");
                    $.ajax({
                        url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editutilitydevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editutilitydevice #devicedescription").val()) + "&used=true",
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            ShowUtilities();
            ...
            dialog_editutilitydevice_buttons[$.t("Remove Device")] = function() {
                ...
                bootbox.confirm($.t("Are you sure to remove this Device?"), function(result) {
                    if (result == true) {
                        $.ajax({
                            url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editutilitydevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editutilitydevice #devicedescription").val()) + "&used=false",
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                ShowUtilities();
            ...
            dialog_editcustomsensordevice_buttons[$.t("Update")] = function() {
                ...
                if (bValid) {
                    ...
                    $.ajax({
                        url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editcustomsensordevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editcustomsensordevice #devicedescription").val()) + "&switchtype=0" + "&customimage=" + CustomImage + "&devoptions=" + encodeURIComponent(soptions) + "&used=true",
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            ShowUtilities();
            ...
            dialog_editcustomsensordevice_buttons[$.t("Remove Device")] = function() {
                ...
                bootbox.confirm($.t("Are you sure to remove this Device?"), function(result) {
                    if (result == true) {
                        $.ajax({
                            url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editcustomsensordevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editcustomsensordevice #devicedescription").val()) + "&used=false",
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                ShowUtilities();
            ...
            dialog_editdistancedevice_buttons[$.t("Update")] = function() {
                ...
                if (bValid) {
                    $(this).dialog("close");
                    $.ajax({
                        url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editdistancedevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editdistancedevice #devicedescription").val()) + "&switchtype=" + $("#dialog-editdistancedevice #combometertype").val() + "&used=true",
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            ShowUtilities();
            ...
            dialog_editdistancedevice_buttons[$.t("Remove Device")] = function() {
                ...
                bootbox.confirm($.t("Are you sure to remove this Device?"), function(result) {
                    if (result == true) {
                        $.ajax({
                            url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editdistancedevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editdistancedevice #devicedescription").val()) + "&used=false",
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                ShowUtilities();
            ...
            dialog_editmeterdevice_buttons[$.t("Update")] = function() {
                ...
                if (bValid) {
                    ...
                    $(this).dialog("close");
                    $.ajax({
                        url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editmeterdevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editmeterdevice #devicedescription").val()) + "&switchtype=" + meterType + "&addjvalue=" + meteroffset + "&used=true" + "&options=" + btoa(encodeURIComponent(devOptionsParam.join(""))),
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            ShowUtilities();
            ...
            dialog_editmeterdevice_buttons[$.t("Remove Device")] = function() {
                ...
                bootbox.confirm($.t("Are you sure to remove this Device?"), function(result) {
                    if (result == true) {
                        $.ajax({
                            url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editmeterdevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editmeterdevice #devicedescription").val()) + "&used=false",
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                ShowUtilities();
            ...
            dialog_editenergydevice_buttons[$.t("Update")] = function() {
                ...
                if (bValid) {
                    $(this).dialog("close");
                    $.ajax({
                        url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editenergydevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editenergydevice #devicedescription").val()) + "&switchtype=" + $("#dialog-editenergydevice #combometertype").val() + "&devoptions=" + $("#dialog-editenergydevice input:radio[name=devoptions]:checked").val() + "&used=true",
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            ShowUtilities();
            ...
            dialog_editenergydevice_buttons[$.t("Remove Device")] = function() {
                ...
                bootbox.confirm($.t("Are you sure to remove this Device?"), function(result) {
                    if (result == true) {
                        $.ajax({
                            url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editenergydevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editenergydevice #devicedescription").val()) + "&used=false",
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                ShowUtilities();
            ...
            dialog_editsetpointdevice_buttons[$.t("Update")] = function() {
                ...
                if (bValid) {
                    $(this).dialog("close");
                    $.ajax({
                        url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editsetpointdevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editsetpointdevice #devicedescription").val()) + "&setpoint=" + $("#dialog-editsetpointdevice #setpoint").val() + "&protected=" + $("#dialog-editsetpointdevice #protected").is(":checked") + "&used=true",
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            ShowUtilities();
            ...
            dialog_editsetpointdevice_buttons[$.t("Remove Device")] = function() {
                ...
                bootbox.confirm($.t("Are you sure to remove this Device?"), function(result) {
                    if (result == true) {
                        $.ajax({
                            url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editsetpointdevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editsetpointdevice #devicedescription").val()) + "&used=false",
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                ShowUtilities();
            ...
            dialog_editthermostatclockdevice_buttons[$.t("Update")] = function() {
                ...
                if (bValid) {
                    ...
                    $.ajax({
                        url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editthermostatclockdevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editthermostatclockdevice #devicedescription").val()) + "&clock=" + encodeURIComponent(daytimestr) + "&protected=" + $("#dialog-editthermostatclockdevice #protected").is(":checked") + "&used=true",
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            ShowUtilities();
            ...
            dialog_editthermostatclockdevice_buttons[$.t("Remove Device")] = function() {
                ...
                bootbox.confirm($.t("Are you sure to remove this Device?"), function(result) {
                    if (result == true) {
                        $.ajax({
                            url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editthermostatclockdevice #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editthermostatclockdevice #devicedescription").val()) + "&used=false",
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                ShowUtilities();
            ...
            dialog_editthermostatmode_buttons[$.t("Update")] = function() {
                ...
                if (bValid) {
                    ...
                    $.ajax({
                        url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editthermostatmode #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editthermostatmode #devicedescription").val()) + modestr + "&protected=" + $("#dialog-editthermostatmode #protected").is(":checked") + "&used=true",
                        async: false,
                        dataType: "json",
                        success: function(data) {
                            ShowUtilities();
            ...
            dialog_editthermostatmode_buttons[$.t("Remove Device")] = function() {
                ...
                bootbox.confirm($.t("Are you sure to remove this Device?"), function(result) {
                    if (result == true) {
                        $.ajax({
                            url: "json.htm?type=setused&idx=" + $.devIdx + "&name=" + encodeURIComponent($("#dialog-editthermostatmode #devicename").val()) + "&description=" + encodeURIComponent($("#dialog-editthermostatmode #devicedescription").val()) + "&used=false",
                            async: false,
                            dataType: "json",
                            success: function(data) {
                                ShowUtilities();
