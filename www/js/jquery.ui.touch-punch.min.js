...
(function( factory ) {
  ...
  mouseProto._mouseDestroy = function () {
    ...
    let el = self.element[0];
    el.removeEventListener('touchstart', self._touchStartBound, { passive: false });
    el.removeEventListener('touchmove',  self._touchMoveBound,  { passive: false });
    el.removeEventListener('touchend',   self._touchEndBound,   { passive: false });
