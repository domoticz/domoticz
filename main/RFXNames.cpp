...
{
	static const STR_TABLE_SINGLE Table[] = {{humstat_normal, "Normal"},
...
{
	static const STR_TABLE_SINGLE Table[] = {{sStatusNormal, "Normal"},
...
{
	static const STR_TABLE_SINGLE Table[] = {{TTYPE_BEFORESUNRISE, "Before Sunrise"},
...
{
	static const STR_TABLE_SINGLE Table[] = {{TCMD_ON, "On"}, {TCMD_OFF, "Off"}, {0, nullptr, nullptr}};
	return findTableIDSingle1(Table, tType);
}
...
{
	static const STR_TABLE_SINGLE Table[] = {{STYPE_OnOff, "On/Off"},
...
{
	static const STR_TABLE_SINGLE Table[] = {{MTYPE_ENERGY, "Energy"},
						 {MTYPE_GAS, "Gas"},
						 {MTYPE_WATER, "Water"},
...
{
	static const STR_TABLE_SINGLE Table[] = {{NTYPE_TEMPERATURE, "Temperature", "T"},
...
{
	static const STR_TABLE_SINGLE Table[] = {{NTYPE_TEMPERATURE, "degrees"},
						 {NTYPE_HUMIDITY, "%"},
						 {NTYPE_RAIN, "mm"},
						 {NTYPE_UV, "UVI"},
						 {NTYPE_WIND, "m/s"},
...
{
	static const STR_TABLE_SINGLE Table[] = {{wsbaroforecast_heavy_snow, "Heavy Snow"},
...
{
	static const STR_TABLE_SINGLE Table[] = {{bmpbaroforecast_stable, "Stable"},
...
{
	static const STR_TABLE_SINGLE Table[] = {{pTypeInterfaceControl, "Interface Control", "unknown"},
...
{
	static const STR_TABLE_ID1_ID2 Table[] = {{pTypeTEMP, sTypeTEMP1, "THR128/138, THC138"},
...
{
	static const STR_TABLE_SINGLE Table[] = {{0, "Monday"}, {1, "Tuesday"},	 {2, "Wednesday"}, {3, "Thursday"},
