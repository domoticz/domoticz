...
const char *Hardware_Type_Desc(int hType)
{
	static const STR_TABLE_SINGLE	Table[] =
	{
		...
		{ HTYPE_RaspberryBMP085, "Raspberry I2C sensor BMP085/180 Temp+Baro" },
		...
		{ HTYPE_RaspberryHTU21D, "Raspberry I2C sensor HTU21D(F)/SI702x Humidity+Temp" },
		...
		{ HTYPE_RaspberryTSL2561, "Raspberry I2C sensor TSL2561 Illuminance" },
		{ 0, NULL, NULL }
	};
