...
constexpr std::array<CEventSystem::_tJsonMap, 52> CEventSystem::JsonMap{
	_tJsonMap{ "Barometer", "barometer", JTYPE_FLOAT },
	_tJsonMap{ "CameraIndx", "cameraIdx", JTYPE_STRING },
	_tJsonMap{ "Chill", "chill", JTYPE_FLOAT },
	_tJsonMap{ "Color", "color", JTYPE_STRING },
	_tJsonMap{ "Counter", "counter", JTYPE_STRING },
	_tJsonMap{ "CounterDeliv", "counterDelivered", JTYPE_FLOAT },
	_tJsonMap{ "CounterDelivToday", "counterDeliveredToday", JTYPE_STRING },
	_tJsonMap{ "CounterToday", "counterToday", JTYPE_STRING },
	_tJsonMap{ "Current", "current", JTYPE_FLOAT },
	_tJsonMap{ "CustomImage", "customImage", JTYPE_INT },
	_tJsonMap{ "DewPoint", "dewPoint", JTYPE_FLOAT },
	_tJsonMap{ "Direction", "direction", JTYPE_FLOAT },
	_tJsonMap{ "DirectionStr", "directionString", JTYPE_STRING },
	_tJsonMap{ "Forecast", "forecast", JTYPE_INT },
	_tJsonMap{ "ForecastStr", "forecastString", JTYPE_STRING },
	_tJsonMap{ "HardwareName", "hardwareName", JTYPE_STRING },
	_tJsonMap{ "HardwareType", "hardwareType", JTYPE_STRING },
	_tJsonMap{ "HardwareTypeVal", "hardwareTypeValue", JTYPE_INT },
	_tJsonMap{ "Humidity", "humidity", JTYPE_INT },
	_tJsonMap{ "HumidityStatus", "humidityStatus", JTYPE_STRING },
	_tJsonMap{ "Image", "Image", JTYPE_STRING },
	_tJsonMap{ "InternalState", "internalState", JTYPE_STRING }, // door contact
	_tJsonMap{ "LevelActions", "levelActions", JTYPE_STRING },
	_tJsonMap{ "LevelInt", "levelVal", JTYPE_INT },
	_tJsonMap{ "LevelNames", "levelNames", JTYPE_STRING },
	_tJsonMap{ "LevelOffHidden", "levelOffHidden", JTYPE_BOOL },
	_tJsonMap{ "MaxDimLevel", "maxDimLevel", JTYPE_INT },
	_tJsonMap{ "Mode", "mode", JTYPE_INT }, // zwave thermostat
	_tJsonMap{ "Modes", "modes", JTYPE_STRING },
	_tJsonMap{ "Moisture", "moisture", JTYPE_STRING },
	_tJsonMap{ "Pressure", "pressure", JTYPE_FLOAT },
	_tJsonMap{ "Protected", "protected", JTYPE_BOOL },
	_tJsonMap{ "Quality", "quality", JTYPE_STRING },
	_tJsonMap{ "Radiation", "radiation", JTYPE_FLOAT },
	_tJsonMap{ "Rain", "rain", JTYPE_FLOAT },
	_tJsonMap{ "RainRate", "rainRate", JTYPE_FLOAT },
	_tJsonMap{ "SensorType", "sensorType", JTYPE_INT },
	_tJsonMap{ "SensorUnit", "sensorUnit", JTYPE_STRING },
	_tJsonMap{ "SetPoint", "setPoint", JTYPE_FLOAT },
	_tJsonMap{ "Speed", "speed", JTYPE_FLOAT },
	_tJsonMap{ "Temp", "temperature", JTYPE_FLOAT },
	_tJsonMap{ "TypeImg", "icon", JTYPE_STRING },
	_tJsonMap{ "Unit", "unit", JTYPE_INT },
	_tJsonMap{ "Until", "until", JTYPE_STRING }, // evohome zone/water
	_tJsonMap{ "Usage", "usage", JTYPE_STRING },
	_tJsonMap{ "UsedByCamera", "usedByCamera", JTYPE_BOOL },
	_tJsonMap{ "UsageDeliv", "usageDelivered", JTYPE_STRING },
	_tJsonMap{ "ValueQuantity", "valueQuantity", JTYPE_STRING },
	_tJsonMap{ "ValueUnits", "valueUnits", JTYPE_STRING },
	_tJsonMap{ "Visibility", "visibility", JTYPE_FLOAT },
	_tJsonMap{ "Voltage", "voltage", JTYPE_FLOAT },
	_tJsonMap{ nullptr, nullptr, JTYPE_STRING },
};
