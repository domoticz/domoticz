...
namespace http {
	namespace server {
		...
		CWebsocket::CWebsocket(boost::function<void(const std::string &packet_data)> _MyWrite, cWebem *_webEm,
				       boost::function<void(const std::string &packet_data)> _WSWrite)
			: OUR_PING_ID("fd")
