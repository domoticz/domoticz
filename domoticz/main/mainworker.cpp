...
unsigned long long MainWorker::decode_Energy(const int HwdID, const tRBUF *pResponse)
{
	...
	usage = (
				double(pResponse->ENERGY.total1) * double(0x10000000000) + 
				double(pResponse->ENERGY.total2) * double(0x100000000) + 
				double(pResponse->ENERGY.total3) * double(0x1000000) +
...
unsigned long long MainWorker::decode_Current_Energy(const int HwdID, const tRBUF *pResponse)
{
	...
	double usage = (double(pResponse->ENERGY.total1) * 0x10000000000 + double(pResponse->ENERGY.total2) * 0x100000000 + double(pResponse->ENERGY.total3) * 0x1000000
