...
unsigned long long MainWorker::decode_Energy(const int HwdID, const tRBUF *pResponse)
{
	...
	usage = double( double(pResponse->ENERGY.total1 * 0x10000000000) + double(pResponse->ENERGY.total2 * 0x100000000) + double(pResponse->ENERGY.total3 * 0x1000000)
				+ double(pResponse->ENERGY.total4 * 0x10000) + double(pResponse->ENERGY.total5 * 0x100) + double(pResponse->ENERGY.total6)) / 223.666;
...
unsigned long long MainWorker::decode_Current_Energy(const int HwdID, const tRBUF *pResponse)
{
	...
	double usage = double( double(pResponse->CURRENT_ENERGY.total1 * 0x10000000000) + double(pResponse->CURRENT_ENERGY.total2 * 0x100000000) + double(pResponse->CURRENT_ENERGY.total3 * 0x1000000)
				+ double(pResponse->CURRENT_ENERGY.total4 * 0x10000) + double(pResponse->CURRENT_ENERGY.total5 * 0x100) + double(pResponse->CURRENT_ENERGY.total6)) / 223.666;
