...
bool MainWorker::EmailCameraSnapshot(const std::string CamIdx, const std::string subject)
{
	int nValue;
	std::string sValue;
	...
	if (!m_camscheduler.TakeSnapshot(CamIdx, camimage))
		return false;
	...
	m_sql.GetPreferencesVar("EmailPort",EmailPort,sValue);
