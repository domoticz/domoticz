	...
	case C_ORG_4BS:
		{
			...
			else
			{
				...
				if (szST=="AMR.Counter")
				{
					...
					sDecodeRXMessage(this, (const unsigned char *)&tsen.RFXMETER, NULL);
				}
				else if (szST=="AMR.Electricity")
				{
					...
					sDecodeRXMessage(this, (const unsigned char *)&umeter, NULL);
				}
				...
				else if (szST == "LightSensor.01")
				{
					...
					if (Manufacturer == 0x0D)
					{
						...
						sDecodeRXMessage(this, (const unsigned char *)&tsen.RFXSENSOR, NULL);
					}
					_tLightMeter lmeter;
					...
					lmeter.dunit=1;
					lmeter.fLux=lux;
					sDecodeRXMessage(this, (const unsigned char *)&lmeter, NULL);
				}
