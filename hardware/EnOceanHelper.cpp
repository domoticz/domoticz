...
const char *EnOceanGetManufacturerLabel(uint32_t ID)
{
...
const char* EnOceanGetManufacturerName(uint32_t ID)
{
...
const char *ESP3GetPacketTypeLabel(uint8_t PT)
{
...
const char *ESP3GetPacketTypeDescription(uint8_t PT)
{
	for (const _tPacketTypeTable* pTable = _packetTypeTable; pTable->PT; pTable++)
		if (pTable->PT == PT)
...
const char *ESP3GetRORGLabel(uint8_t RORG)
{
...
const char *ESP3GetRORGDescription(uint8_t RORG)
{
	for (const _tRORGTable* pTable = _RORGTable; pTable->RORG; pTable++)
		if (pTable->RORG == RORG)
			return pTable->description;
...
const char *ESP3GetReturnCodeLabel(uint8_t RC)
{
...
const char *ESP3GetReturnCodeDescription(uint8_t RC)
{
