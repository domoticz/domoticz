...
protected:
	...
	void SendSelectorSwitch(const int NodeID, const uint8_t ChildID, const int sValue, const std::string& defaultname, const int customImage , const bool Dropdown, const std::string& LevelNames,const std::string& LevelActions, const bool nooff);
