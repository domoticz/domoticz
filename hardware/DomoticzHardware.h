...
protected:
	...
	void SendSwitch(const int NodeID, const int ChildID, const int BatteryLevel, const bool bOn, const unsigned char Level, const std::string &defaultname);
	void SendSwitchIfNotExists(const int NodeID, const int ChildID, const int BatteryLevel, const bool bOn, const unsigned char Level, const std::string &defaultname);
