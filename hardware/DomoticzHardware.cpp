...
void CDomoticzHardwareBase::SendPercentageSensor(const int NodeID, const int ChildID, const int BatteryLevel, const float Percentage, const char* defaultname)
{
	_tGeneralDevice gDevice;
