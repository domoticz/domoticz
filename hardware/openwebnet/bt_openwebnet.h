...
public:
  ...
  bt_openwebnet(int who, int where, int what);
 ...
 static bool ParseData(char* data, int length, vector<bt_openwebnet>& messages);
 ...
 // TODO remove
 static vector<string> Extract_addresses();
 static vector<string> Extract_whatParameters();
 static vector<string> Extract_whereParameters();
 static vector<string> Extract_values();
  ...
  enum _eTemperatureControlDimension {
