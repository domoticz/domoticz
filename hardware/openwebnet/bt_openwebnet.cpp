...
bool bt_openwebnet::IsEqual(const bt_openwebnet& msg_to_compare)
{
  ...
  if(!m_extended)
  {
	  if ((msg_to_compare.Extract_who() == m_who) && (msg_to_compare.Extract_what() == m_what) && (msg_to_compare.Extract_where() == m_where) && (msg_to_compare.Extract_when() == m_when) &&
  ...
  {
	  if ((msg_to_compare.Extract_who() == m_who) && (msg_to_compare.Extract_what() == m_what) && (msg_to_compare.Extract_where() == m_where) && (msg_to_compare.Extract_level() == m_level) &&
