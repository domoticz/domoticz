...
public:
	...
	static bool GET(const std::string &url, const std::vector<std::string> &ExtraHeaders, std::string &response, std::string &headerdata, const bool bIgnoreNoDataReturned = false);
	...
	static bool GETBinary(const std::string &url, const std::vector<std::string> &ExtraHeaders, std::vector<unsigned char> &response, std::vector<unsigned char> &headerdata, const int TimeOut = -1);
	...
	static bool POST(const std::string &url, const std::string &postdata, const std::vector<std::string> &ExtraHeaders, std::string &response, std::string &headerdata, const bool bFollowRedirect=true, const bool bIgnoreNoDataReturned = false);
	...
	static bool POSTBinary(const std::string &url, const std::string &postdata, const std::vector<std::string> &ExtraHeaders, std::vector<unsigned char> &response, std::vector<unsigned char> &headerdata, const bool bFollowRedirect = true);
