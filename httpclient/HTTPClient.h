...
class HTTPClient
{
	...
	static bool GET(const std::string &url, std::string &response, bool bIgnoreNoDataReturned = false, const std::string &userPwd = "");
	...
	static bool GET(const std::string &url, const std::vector<std::string> &ExtraHeaders, std::string &response, bool bIgnoreNoDataReturned = false, const std::string &userPwd = "");
	...
	static bool GET(const std::string &url, const std::vector<std::string> &ExtraHeaders, std::string &response, std::vector<std::string> &vHeaderData, bool bIgnoreNoDataReturned = false, const std::string &userPwd = "");
	...
	static bool GETBinary(const std::string &url, const std::vector<std::string> &ExtraHeaders, std::vector<unsigned char> &response, long TimeOut = -1, const std::string &userPwd = "");
	...
	static bool GETBinary(const std::string &url, const std::vector<std::string> &ExtraHeaders, std::vector<unsigned char> &response, std::vector<std::string> &vHeaderData, long TimeOut = -1, const std::string &userPwd = "");
