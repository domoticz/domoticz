									...
									if (($scope.config.DashboardType==2)||(window.myglobals.ismobile==true)) {
										...
										if (item.SwitchType == "Doorbell") {
										    ...
										    if ((item.Status != 'Off') && (item.Status != '0')) {
										        ...
										        img2 = '<img src="images/remote48.png" onclick="ShowMediaRemote(\'' + encodeURIComponent(item.Name) + "'," +  item.idx + ');" class="lcursor" height="40" width="40">';
										    }
										    else {
								...
								if (($scope.config.DashboardType==2)||(window.myglobals.ismobile==true)) {
									...
									if (item.SwitchType == "Doorbell") {
									    ...
									    if ((item.Status != 'Off') && (item.Status != '0')) {
									        ...
									        xhtm += '\t      <td id="img2"><img src="images/remote48.png" onclick="ShowMediaRemote(\'' + encodeURIComponent(item.Name) + "'," +  item.idx + ');" class="lcursor" height="40" width="40"></td>\n';
									    }
									    else {
